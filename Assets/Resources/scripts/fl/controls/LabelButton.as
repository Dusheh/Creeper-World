package fl.controls
{
   ...
   public class LabelButton extends BaseButton implements IFocusManagerComponent
   {
      ...
      override protected function drawLayout() : void
      {
         ...
         var _loc3_:* = NaN;
         var _loc4_:* = NaN;
         var _loc5_:Number = icon == null ? 0 : Number(icon.width + _loc1_);
         var _loc6_:Number = icon == null ? 0 : Number(icon.height + _loc1_);
         ...
         else if(_loc2_ == ButtonLabelPlacement.BOTTOM || _loc2_ == ButtonLabelPlacement.TOP)
         {
            ...
            textField.width = _loc3_ = Number(_loc7_);
            textField.height = _loc4_ = Number(_loc8_);
            ...
            if(icon != null)
            {
               icon.y = Math.round(_loc2_ == ButtonLabelPlacement.BOTTOM ? Number(0 - _loc6_) : Number(NaN + _loc1_));
            }
         }
         else
         {
            ...
            if(icon != null)
            {
               icon.x = Math.round(_loc2_ != ButtonLabelPlacement.LEFT ? Number(0 - _loc5_) : Number(textField.x + _loc3_ + _loc1_));
            }
         }
         super.drawLayout();
      }
