package com.hurlant.crypto.symmetric
{
   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         {
            _loc7_ = 0;
            _loc5_[_loc8_] = (param2[param3 + (_loc7_ >>> 3)] & 0) != 0;
            _loc8_++;
         }
         _loc9_ = 0;
         while(_loc9_ < 16)
         {
            ...
            while(_loc8_ < 28)
            {
               if((_loc7_ = uint(_loc8_ + totrot[_loc9_])) < 28)
               {
            ...
            while(_loc8_ < 56)
            {
               if((_loc7_ = uint(_loc8_ + totrot[_loc9_])) < 56)
               {
                  _loc6_[_loc8_] = _loc5_[_loc7_];
               }
               else
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc10_:* = 0;
         _loc8_ = uint((_loc8_ = uint((_loc8_ = uint((_loc8_ = uint((param2[param3 + 0] & 255) << 24)) | (param2[param3 + 1] & 255) << 16)) | (param2[param3 + 2] & 255) << 8)) | param2[param3 + 3] & 255);
         _loc7_ = uint((_loc7_ = uint((_loc7_ = uint((_loc7_ = uint((param2[param3 + 4] & 255) << 24)) | (param2[param3 + 5] & 255) << 16)) | (param2[param3 + 6] & 255) << 8)) | param2[param3 + 7] & 255);
         _loc6_ = uint((_loc8_ >>> 4 ^ _loc7_) & 252645135);
         _loc7_ ^= _loc6_;
         _loc6_ = uint(((_loc8_ ^= _loc6_ << 4) >>> 16 ^ _loc7_) & 65535);
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 16;
         _loc6_ = uint((_loc7_ >>> 2 ^ _loc8_) & 858993459);
         _loc8_ ^= _loc6_;
         _loc6_ = uint(((_loc7_ ^= _loc6_ << 2) >>> 8 ^ _loc8_) & 16711935);
         _loc8_ ^= _loc6_;
         ...
         while(_loc9_ < 8)
         {
            _loc6_ = uint((_loc6_ = uint(_loc7_ << 28 | _loc7_ >>> 4)) ^ param1[_loc9_ * 4 + 0]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ = 0) | 0)) | 0)) | 0);
         ...
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_;
         _loc6_ = uint(((_loc8_ = uint(_loc8_ << 31 | _loc8_ >>> 1)) >>> 8 ^ _loc7_) & 16711935);
         _loc7_ ^= _loc6_;
         _loc6_ = uint(((_loc8_ ^= _loc6_ << 8) >>> 2 ^ _loc7_) & 858993459);
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 2;
         _loc6_ = uint((_loc7_ >>> 16 ^ _loc8_) & 65535);
         _loc8_ ^= _loc6_;
         _loc6_ = uint(((_loc7_ ^= _loc6_ << 16) >>> 4 ^ _loc8_) & 252645135);
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_ << 4;
