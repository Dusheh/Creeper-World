   ...
   public class AESKey implements ISymmetricKey
   {
      ...
      private function expandKey() : void
      {
         ...
         while(_loc6_ < Nb * (Nr + 1))
         {
            ...
            key[4 * _loc6_ + 0] = 0 ^ _loc1_;
            key[4 * _loc6_ + 1] = 0 ^ _loc2_;
            key[4 * _loc6_ + 2] = 0 ^ _loc3_;
            key[4 * _loc6_ + 3] = 0 ^ _loc4_;
            _loc6_++;
         }
      }
      ...
      protected function addRoundKey(param1:ByteArray, param2:uint) : void
      {
         ...
         while(_loc3_ < 16)
         {
            state[_loc3_] = 0 ^ param1[_loc3_ + param2];
            _loc3_++;
         }
      }
