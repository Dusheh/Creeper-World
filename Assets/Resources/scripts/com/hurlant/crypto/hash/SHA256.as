   ...
   public class SHA256 extends SHABase implements IHash
   {
      ...
      override protected function core(param1:Array, param2:uint) : Array
      {
         ...
         while(_loc12_ < param1.length)
         {
            ...
            _loc17_ = uint(_loc8_);
            _loc18_ = uint(_loc9_);
            _loc19_ = uint(_loc10_);
            _loc20_ = uint(_loc11_);
            _loc21_ = 0;
            while(_loc21_ < 64)
            {
               if(_loc21_ < 16)
               {
                  _loc3_[_loc21_] = param1[_loc12_ + _loc21_] || false;
               }
               else
               {
                  _loc24_ = uint(rrol(_loc3_[_loc21_ - 15],7) ^ rrol(_loc3_[_loc21_ - 15],18) ^ _loc3_[_loc21_ - 15] >>> 3);
                  _loc25_ = uint(rrol(_loc3_[_loc21_ - 2],17) ^ rrol(_loc3_[_loc21_ - 2],19) ^ _loc3_[_loc21_ - 2] >>> 10);
                  _loc3_[_loc21_] = _loc3_[_loc21_ - 16] + _loc24_ + _loc3_[_loc21_ - 7] + _loc25_;
               }
               _loc22_ = uint((rrol(_loc4_,2) ^ rrol(_loc4_,13) ^ rrol(_loc4_,22)) + (_loc4_ & _loc5_ ^ _loc4_ & _loc6_ ^ _loc5_ & _loc6_));
               _loc23_ = uint(_loc11_ + (rrol(_loc8_,6) ^ rrol(_loc8_,11) ^ rrol(_loc8_,25)) + (_loc8_ & _loc9_ ^ _loc10_ & ~_loc8_) + k[_loc21_] + _loc3_[_loc21_]);
               _loc11_ = uint(_loc10_);
               _loc10_ = uint(_loc9_);
               _loc9_ = uint(_loc8_);
               _loc8_ = uint(_loc7_ + _loc23_);
               _loc7_ = uint(_loc6_);
               _loc6_ = uint(_loc5_);
               _loc5_ = uint(_loc4_);
               _loc4_ = uint(_loc23_ + _loc22_);
               _loc21_++;
            }
            _loc4_ += _loc13_;
            _loc5_ += _loc14_;
