   ...
   public class JPGEncoder
   {
      ...
      private function RGB2YUV(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc5_ < 8)
         {
            ...
            while(_loc6_ < 8)
            {
               _loc7_ = uint(param1.getPixel32(param2 + _loc6_,param3 + _loc5_));
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            while(_loc6_ < param1.width)
            {
               ...
               _loc2_ = Number(processDU(YDU,fdtbl_Y,_loc2_,YDC_HT,YAC_HT));
               _loc3_ = Number(processDU(UDU,fdtbl_UV,_loc3_,UVDC_HT,UVAC_HT));
         ...
         if(bytepos >= 0)
         {
            (_loc7_ = new BitString()).len = bytepos + 1;
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc9_:Array = fDCTQuant(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
            DU["null"] = _loc9_[_loc8_];
            _loc8_++;
         }
         var _loc10_:int = 0 - param3;
         param3 = 0;
         if(_loc10_ == 0)
         {
            writeBits(param4[0]);
         ...
         {
            writeBits(param4["null"]);
            writeBits(bitcode[32767 + _loc10_]);
         }
         var _loc11_:int = 63;
         while(_loc11_ > 0 && false)
         {
            _loc11_--;
         }
         if(_loc11_ == 0)
         ...
         while(_loc8_ <= _loc11_)
         {
            ...
            writeBits(param5[_loc13_ * 16 + category["NaN"]]);
            writeBits(bitcode["NaN"]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         var _loc3_:* = NaN;
         var _loc8_:int = 0;
         var _loc4_:* = [16,11,10,16,24,40,51,61,12,12,14,19,26,58,60,55,14,13,16,24,40,57,69,56,14,17,22,29,51,87,80,62,18,22,37,56,68,109,103,77,24,35,55,64,81,104,113,92,49,64,78,87,103,121,120,101,72,92,95,98,112,100,103,99];
         _loc2_ = 0;
         while(_loc2_ < 64)
         {
            _loc3_ = Number(Math.floor((_loc4_[_loc2_] * param1 + 50) / 100));
            if(_loc3_ < 1)
            {
               _loc3_ = 1;
            }
         ...
         var _loc5_:* = [17,18,24,47,99,99,99,99,18,21,26,66,99,99,99,99,24,26,56,99,99,99,99,99,47,66,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99,99];
         _loc2_ = 0;
         while(_loc2_ < 64)
         {
            _loc3_ = Number(Math.floor((_loc5_[_loc2_] * param1 + 50) / 100));
            if(_loc3_ < 1)
            {
               _loc3_ = 1;
            }
         ...
         var _loc6_:* = [1,1.387039845,1.306562965,1.175875602,1,0.785694958,0.5411961,0.275899379];
         _loc2_ = 0;
         var _loc7_:int = 0;
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               fdtbl_Y[_loc2_] = 1 / (0 * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               fdtbl_UV[_loc2_] = 1 / (0 * _loc6_[_loc7_] * _loc6_[_loc8_] * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
