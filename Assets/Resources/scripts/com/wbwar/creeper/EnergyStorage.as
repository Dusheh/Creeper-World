package com.wbwar.creeper
{
   ...
   public final class EnergyStorage extends Place
   {
      
      public static const BASE_COST:int = 100;
      
      private static var bodyImage:Class = EnergyStorage_bodyImage;
      ...
      public function EnergyStorage(param1:int, param2:int)
      {
         super(param1,param2);
         cacheAsBitmap = true;
