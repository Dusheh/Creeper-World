package com.wbwar.creeper.util
{
   ...
   public class MessageDialog extends Sprite
   {
      ...
      public static const OK_CLICK:String = "com.wbwar.creeper.util.MessageDialog.OK_CLICK";
      ...
      public function MessageDialog(param1:int, param2:int, param3:int, param4:int, param5:Boolean, param6:Boolean = false)
      {
         super();
         this.side = param1;
         this.loc = param2;
