package com.wbwar.creeper.screens
{
   ...
   public class UnchartedSubmitScoreScreen extends Sprite
   {
      
      public static const HIDDEN:String = "com.webwar.creeper.screens.UnchartedSubmitScoreScreen.HIDDEN";
      
      public static const WIDTH:int = 700;
      
      public static const HEIGHT:int = 525;
      
      private static const SUBMITSPRITE_WIDTH:int = 250;
      ...
      private var controller:UnchartedMissionSelection;
      
      public function UnchartedSubmitScoreScreen(param1:UnchartedMissionSelection)
      {
         var nameTitle:TextField = null;
         var controller:UnchartedMissionSelection = param1;
         super();
         ...
         var groupTitle:TextField = Text.text("Group Name (Optional)",10,16777215);
         groupTitle.x = 10;
         groupTitle.y = 50;
      ...
      private function onSubmitClick(param1:Event) : void
      {
         ...
         GameData.save();
         Score.submitScoreUncharted(this.map,_loc2_,_loc3_,this.systemScore,this.systemPlayCount,this.submitComplete,this.errorComplete);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IndividualGameData = GameData.getUnchartedGameData(this.map);
         if(_loc2_ != null)
         {
            _loc3_ = new Date();
            _loc2_.scoreSubmitted = _loc3_.getTime();
            GameData.save();
         }
         this.controller.unchartedMapSelector.reinit();
         this.hide();
      }
      ...
      public function show(param1:String, param2:int, param3:int, param4:String) : void
      {
         this.map = param1;
         if(false)
         {
         ...
         this.systemTitle.text = param4;
         this.systemTitle.x = this.submitSprite.width / 2 - this.systemTitle.width / 2;
         this.systemScore = param2;
         this.systemPlayCount = param3;
         this.systemScoreText.text = String(param2);
         this.systemPlayCountText.text = "# Plays: " + String(param3);
         this.systemScoreText.x = SUBMITSPRITE_WIDTH / 2 - this.systemScoreText.width / 2;
