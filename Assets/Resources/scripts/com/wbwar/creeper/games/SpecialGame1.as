package com.wbwar.creeper.games
{
   ...
   public class SpecialGame1 extends Game
   {
      
      public static var title:String = "Super Tax-Man";
      
      public static var gameData:Class = SpecialGame1_gameData;
      ...
      private function createProducers(param1:Object = null) : void
      {
         var _loc2_:* = null;
         enableGame();
         _loc2_ = new GlopProducer(45,19);
         _loc2_.productionBaseAmt = 5;
         _loc2_.productionInterval = 10;
