package com.wbwar.creeper.games
{
   ...
   public class SpecialGame6 extends Game
   {
      
      public static var title:String = "Poison";
      
      public static var gameData:Class = SpecialGame6_gameData;
