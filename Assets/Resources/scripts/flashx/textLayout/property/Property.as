package flashx.textLayout.property
{
   ...
   public class Property
   {
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,tlf_internal::sharedBooleanHandler,tlf_internal::sharedInheritEnumHandler);
         return _loc5_;
      }
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,tlf_internal::sharedStringHandler);
         return _loc5_;
      }
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,tlf_internal::sharedUintHandler,tlf_internal::sharedInheritEnumHandler);
         return _loc5_;
      }
      ...
      {
         var _loc6_:Property;
         (_loc6_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new EnumPropertyHandler(rest),tlf_internal::sharedInheritEnumHandler);
         return _loc6_;
      }
      ...
      {
         var _loc8_:Property;
         (_loc8_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new EnumPropertyHandler(rest),new IntPropertyHandler(param5,param6),tlf_internal::sharedInheritEnumHandler);
         return _loc8_;
      }
      ...
      {
         var _loc6_:Property;
         (_loc6_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new EnumPropertyHandler(rest),tlf_internal::sharedUintHandler,tlf_internal::sharedInheritEnumHandler);
         return _loc6_;
      }
      ...
      {
         var _loc7_:Property;
         (_loc7_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new NumberPropertyHandler(param5,param6),tlf_internal::sharedInheritEnumHandler);
         return _loc7_;
      }
      ...
      {
         var _loc10_:Property;
         (_loc10_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new EnumPropertyHandler(rest),new PercentPropertyHandler(param7,param8),new NumberPropertyHandler(param5,param6),tlf_internal::sharedInheritEnumHandler);
         return _loc10_;
      }
      ...
      {
         var _loc9_:Property;
         (_loc9_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new PercentPropertyHandler(param7,param8),new NumberPropertyHandler(param5,param6),tlf_internal::sharedInheritEnumHandler);
         return _loc9_;
      }
      ...
      {
         var _loc8_:Property;
         (_loc8_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new EnumPropertyHandler(rest),new NumberPropertyHandler(param5,param6),tlf_internal::sharedInheritEnumHandler);
         return _loc8_;
      }
      ...
      {
         var _loc7_:Property;
         (_loc7_ = new Property(param1,param2,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,new SpacingLimitPropertyHandler(param5,param6),tlf_internal::sharedInheritEnumHandler);
         return _loc7_;
      }
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,undefinedValue,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,tlf_internal::sharedTextLayoutFormatHandler,tlf_internal::sharedInheritEnumHandler);
         return _loc5_;
      }
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,undefinedValue,param3,param4)).addHandlers(tlf_internal::sharedUndefinedHandler,tlf_internal::sharedListMarkerFormatHandler,tlf_internal::sharedInheritEnumHandler);
         return _loc5_;
      }
      ...
      public static function extractInCategory(param1:Class, param2:Object, param3:Object, param4:String, param5:Boolean = true) : Object
      {
         ...
         for each(_loc7_ in param2)
         {
            if(param3[_loc7_.name] != null)
            {
               ...
               else if(_loc7_.categories.indexOf(param4) == -1)
               {
                  continue;
               }
               if(_loc6_ == null)
      ...
      private static function compareStylesLoop(param1:Object, param2:Object, param3:Object) : Boolean
      {
         ...
         for(_loc4_ in param1)
         {
            ...
            if(_loc5_ != _loc6_)
            {
               ...
               if(!(_loc7_ = param3[_loc4_]) || !equalAllHelper(_loc7_.memberType.description,_loc5_,_loc6_))
               {
                  return false;
               }
            }
      ...
      public static function equalStyles(param1:Object, param2:Object, param3:Object) : Boolean
      {
         if(param1 == null)
         {
            param1 = tlf_internal::nullStyleObject;
         }
         if(param2 == null)
         {
            param2 = tlf_internal::nullStyleObject;
         }
      ...
      public function setHelper(param1:*, param2:*) : *
      {
         ...
         {
            if((_loc4_ = _loc3_.owningHandlerCheck(param2)) !== undefined)
            {
      ...
      public function get maxPercentValue() : Number
      {
         ...
         return !!_loc1_ ? Number(_loc1_.maxValue) : Number(NaN);
      }
      
      public function get minPercentValue() : Number
      {
         var _loc1_:PercentPropertyHandler = this.findHandler(PercentPropertyHandler) as PercentPropertyHandler;
         return !!_loc1_ ? Number(_loc1_.minValue) : Number(NaN);
      }
      ...
      public function get minValue() : Number
      {
         ...
         return !!_loc2_ ? Number(_loc2_.minValue) : Number(NaN);
      }
      ...
      public function get maxValue() : Number
      {
         ...
         var _loc2_:IntPropertyHandler = this.findHandler(IntPropertyHandler) as IntPropertyHandler;
         return !!_loc2_ ? Number(_loc2_.maxValue) : Number(NaN);
      }
      ...
      public function computeActualPropertyValue(param1:Object, param2:Number) : Number
      {
         ...
         return !!this._numberPropertyHandler ? Number(this._numberPropertyHandler.clampToRange(_loc4_)) : Number(_loc4_);
      }
   }
}
