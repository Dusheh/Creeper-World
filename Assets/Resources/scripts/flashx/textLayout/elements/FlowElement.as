package flashx.textLayout.elements
{
   ...
   public class FlowElement implements ITextLayoutFormat
   {
      ...
      tlf_internal static function createTextLayoutFormatPrototype(param1:ITextLayoutFormat, param2:TextLayoutFormat) : TextLayoutFormat
      {
         ...
         if(param2)
         {
            if((_loc5_ = param2.getStyles()).hasNonInheritedStyles !== undefined)
            {
            ...
            if(_loc13_ = param1 as TextLayoutFormat)
            {
               ...
               for(_loc7_ in _loc14_)
               {
                  if((_loc8_ = _loc14_[_loc7_]) == FormatValue.INHERIT)
                  {
                     if(param2)
                     {
                        if((_loc9_ = TextLayoutFormat.description[_loc7_]) && !_loc9_.inherited)
                        {
         ...
         if(!_loc4_)
         {
            ...
            (_loc11_ = new TextLayoutFormat()).setStyles(_loc6_,true);
            return _loc11_;
         }
         if(_loc10_)
         {
         ...
         (_loc11_ = new TextLayoutFormat()).setStyles(_loc6_,false);
         return _loc11_;
      }
      ...
      tlf_internal function deleteContainerText(param1:int, param2:int) : void
      {
         ...
         if(this.getTextFlow())
         {
            ...
            while(param2 > 0)
            {
               if(!(_loc6_ = this.getEnclosingController(param1 - 1)))
               {
                  if(_loc6_ = this.getEnclosingController(param1 - param2))
                  {
               ...
               if((_loc8_ = _loc6_.textLength < _loc5_ ? int(_loc6_.textLength) : int(_loc5_)) <= 0)
               {
                  break;
               }
