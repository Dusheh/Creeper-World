package flashx.textLayout.elements
{
   ...
   public class FlowGroupElement extends FlowElement
   {
      ...
      {
         return param1 is Array ? uint(param1.length) : uint(1);
      }
      ...
      public function replaceChildren(param1:int, param2:int, ... rest) : void
      {
         ...
         var _loc6_:int = param1 == this._numChildren ? int(textLength) : int(this.getChildAt(param1).parentRelativeStart);
         if(param1 < param2)
         {
            _loc14_ = 0;
            while(param1 < param2)
                     ...
                     if(_loc16_ = _loc10_.parent)
                     {
                        if(_loc16_ == this)
                        {
                           ...
                           if(_loc17_ <= param1)
                           {
                              ...
                              _loc6_ = param1 == this._numChildren ? int(textLength) : int(this.getChildAt(param1).parentRelativeStart);
                           }
                        }
                        else
                        {
         ...
         if(_loc7_)
         {
            ...
            if(_loc18_)
            {
               ...
               if(_loc19_ = getEnclosingController(_loc6_))
               {
      ...
      override tlf_internal function applyWhiteSpaceCollapse(param1:String) : void
      {
         ...
         while(_loc2_ < this._numChildren)
         {
            (_loc5_ = this.getChildAt(_loc2_)).applyWhiteSpaceCollapse(param1);
      ...
      override tlf_internal function appendElementsForDelayedUpdate(param1:TextFlow, param2:String) : void
      {
         ...
         {
            (_loc4_ = this.getChildAt(_loc3_)).appendElementsForDelayedUpdate(param1,param2);
            _loc3_++;
         }
      }
   }
