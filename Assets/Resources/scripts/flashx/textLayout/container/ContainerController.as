   ...
   public class ContainerController implements IInteractionEventHandler, ITextLayoutFormat, ISandboxSupport
   {
      ...
      public function setCompositionSize(param1:Number, param2:Number) : void
      {
         ...
         if(_loc3_ || _loc4_)
         {
            ...
            if(this.effectiveBlockProgression == BlockProgression.TB ? Boolean(_loc3_) : Boolean(_loc4_))
            {
      ...
      private function gatherVisibleLines(param1:String, param2:Boolean) : void
      {
         var _loc15_:* = null;
         var _loc16_:* = null;
         var _loc3_:Number = !!this._measureWidth ? Number(this._contentWidth) : Number(this._compositionWidth);
         var _loc4_:Number = !!this._measureHeight ? Number(this._contentHeight) : Number(this._compositionHeight);
         var _loc5_:Number = param1 == BlockProgression.RL ? Number(this._xScroll - _loc3_) : Number(this._xScroll);
         ...
         while(_loc14_ <= _loc13_)
         {
            ...
            {
               if(_loc16_ = this.isLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc15_,null))
               {
                  if(param2)
                  {
      ...
      tlf_internal function checkScrollBounds() : void
      {
         ...
         {
            if((_loc4_ = !_loc3_ && _loc1_ > _loc2_) != this._mouseWheelListenerAttached)
            {
      ...
      private function computeHorizontalScrollPosition(param1:Number, param2:Boolean) : Number
      {
         ...
         if(_loc4_ > this._compositionWidth && !this._measureWidth)
         {
            ...
            {
               _loc5_ = Number(pinValue(param1,this._contentLeft + this._compositionWidth,this._contentLeft + _loc4_));
               if(param2 && this._uncomposedTextLength != 0 && _loc5_ != this._xScroll)
               {
                  ...
                  _loc5_ = Number(pinValue(param1,this._contentLeft + this._compositionWidth,this._contentLeft + this._contentWidth));
               }
            }
            else
            {
               _loc5_ = Number(pinValue(param1,this._contentLeft,this._contentLeft + _loc4_ - this._compositionWidth));
            }
         }
         return _loc5_;
      }
      ...
      private function computeVerticalScrollPosition(param1:Number, param2:Boolean) : Number
      {
         ...
         {
            _loc3_ = Number(pinValue(param1,this._contentTop,this._contentTop + (_loc4_ - this._compositionHeight)));
      ...
      private function get containerScrollRectLeft() : Number
      {
         ...
         {
            _loc1_ = Number(this.effectiveBlockProgression == BlockProgression.RL ? Number(this.horizontalScrollPosition - this.compositionWidth) : Number(this.horizontalScrollPosition));
         }
         return _loc1_;
      }
      ...
      private function get containerScrollRectTop() : Number
      {
         ...
         {
            _loc1_ = Number(this.verticalScrollPosition);
         }
         return _loc1_;
      }
      ...
      private function rangeToRectangle(param1:int, param2:int, param3:int, param4:int) : Rectangle
      {
         ...
         if(param3 == param4)
         {
            if((_loc8_ = _loc7_.getLineAt(param3)).isDamaged())
            {
               return null;
            }
      ...
      public function getScrollDelta(param1:int) : Number
      {
         ...
         if(this.effectiveBlockProgression == BlockProgression.RL)
         {
            return (_loc9_ = param1 < 0 ? Number(_loc7_.x + _loc7_.textHeight) : Number(_loc7_.x - _loc7_.descent + this._compositionWidth)) - this.horizontalScrollPosition;
         }
         return (_loc9_ = param1 < 0 ? Number(_loc7_.y) : Number(_loc7_.y + _loc7_.textHeight - this._compositionHeight)) - this.verticalScrollPosition;
      }
      ...
      {
         this.blinkObject.alpha = this.blinkObject.alpha == 1 ? 0 : Number(1);
      }
      ...
      tlf_internal function addSelectionShapes(param1:SelectionFormat, param2:int, param3:int) : void
      {
         ...
         if(param2 != param3)
         {
            ...
            if((_loc9_ = param2 == param3 ? int(_loc8_) : int(this.flowComposer.findLineIndexAtPosition(param3))) >= this.flowComposer.numLines)
            {
            ...
            while(_loc12_ <= _loc9_)
            {
               ...
               _loc11_.hiliteBlockSelection(_loc10_,param1,this._container,param2 < _loc11_.absoluteStart ? int(_loc11_.absoluteStart) : int(param2),param3 > _loc11_.absoluteStart + _loc11_.textLength ? int(_loc11_.absoluteStart + _loc11_.textLength) : int(param3),_loc4_,_loc5_);
               _loc13_ = _loc11_;
               _loc11_ = _loc5_;
               _loc4_ = _loc13_;
               _loc12_++;
      ...
      tlf_internal function updateCompositionShapes() : void
      {
         ...
         if(this._updateStart > this.absoluteStart && _loc4_.length > 0)
         {
            ...
            _loc16_ = (_loc15_ = this.flowComposer.findLineAtPosition(_loc14_.absoluteStart - 1)).peekTextLine();
         ...
         this._mouseEventManager.updateHitTests(this.effectiveBlockProgression == BlockProgression.RL && this._hasScrollRect ? Number(this._contentWidth) : Number(0),scratchRectangle,_loc9_,!!_loc11_ ? int(_loc11_.absoluteStart) : int(this._absoluteStart),!!_loc12_ ? int(_loc12_.absoluteStart + _loc12_.textLength - 1) : int(this._absoluteStart),_loc10_);
      ...
      tlf_internal function updateGraphics(param1:int) : void
      {
         ...
         var _loc13_:Number = !!this._measureWidth ? Number(this._contentWidth) : Number(this._compositionWidth);
         var _loc14_:Number = !!this._measureHeight ? Number(this._contentHeight) : Number(this._compositionHeight);
         var _loc15_:Number = _loc12_ == BlockProgression.RL ? Number(this._xScroll - _loc13_) : Number(this._xScroll);
         ...
         if(false)
         {
            while(param1 < param2)
            {
               if(!(_loc4_ = this._shapeChildren[param1++]).parent)
               {
                  ...
                  else if(!((_loc7_ = _loc4_.userData as TextFlowLine) && _loc7_.controller != this))
                  {
      ...
      tlf_internal function isLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int, param6:TextFlowLine, param7:TextLine) : TextLine
      {
         ...
         if((param1 == BlockProgression.TB ? Boolean(this._measureHeight) : Boolean(this._measureWidth)) || param6.isLineVisible(param1,param2,param3,param4,param5))
         {
      ...
      private function computeLineBoundsWithGraphics(param1:TextFlowLine, param2:TextLine, param3:Rectangle) : Rectangle
      {
         ...
         if(this._composedFloats)
         {
            ...
            while(_loc4_ < _loc5_)
            {
               ...
               {
                  if(_loc10_ = (_loc9_ = this.textFlow.findLeaf(_loc8_.absolutePosition) as InlineGraphicElement).placeholderGraphic.parent)
                  {
