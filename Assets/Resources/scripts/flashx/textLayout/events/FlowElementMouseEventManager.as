package flashx.textLayout.events
{
   ...
   public class FlowElementMouseEventManager
   {
      ...
      public function FlowElementMouseEventManager(param1:DisplayObjectContainer, param2:Array)
      {
         ...
         this._eventListeners["null"] = this._eventListeners["null"] = this._eventListeners["null"] = this._eventListeners["null"] = this._eventListeners["null"] = this._eventListeners["null"] = this._eventListeners["null"] = this.THIS_HANDLES_EVENT;
      ...
      public function updateHitTests(param1:Number, param2:Rectangle, param3:TextFlow, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         if(_loc9_.length != 0)
         {
            ...
            for each(_loc12_ in _loc9_)
            {
               ...
               {
                  (_loc7_ = _loc8_.rect).x = param2.x + _loc8_.textLine.x + _loc7_.x + param1;
                  _loc7_.y = param2.y + _loc8_.textLine.y + _loc7_.y;
                  if(!(_loc7_ = _loc7_.intersection(param2)).isEmpty())
                  {
                     ...
                     if(!(_loc17_ = _loc10_[_loc16_]) || _loc17_.owner != _loc12_)
                     {
                        _loc10_[_loc16_] = {
                           "rect":_loc7_,
                           "owner":_loc12_
      ...
      tlf_internal function collectElements(param1:FlowGroupElement, param2:int, param3:int, param4:Array) : void
      {
         ...
         {
            if((_loc6_ = param1.getChildAt(_loc5_)).parentRelativeStart >= param3)
            {
               break;
            }
            ...
            if(_loc7_ = _loc6_ as FlowGroupElement)
            {
