      ...
      override public function doOperation() : Boolean
      {
         ...
         if(_loc2_ == _loc1_.numChildren)
         {
            ...
            if(!(_loc6_ is ListItemElement))
            {
               ...
               if(_loc7_.normalizeNeedsInitialParagraph())
               {
         ...
         else
         {
            ...
            if(_loc1_ is ListItemElement && (_loc1_ as ListItemElement).normalizeNeedsInitialParagraph())
            {
            ...
            if((_loc8_ = _loc1_ as ListItemElement) && _loc8_.normalizeNeedsInitialParagraph())
            {
               this._mementoList.push(ModelEdit.addElement(textFlow,new ParagraphElement(),_loc8_,0));
            }
            if((_loc8_ = _loc1_.parent as ListItemElement) && _loc8_.normalizeNeedsInitialParagraph())
            {
               this._mementoList.push(ModelEdit.addElement(textFlow,new ParagraphElement(),_loc8_,0));
            }
         }
