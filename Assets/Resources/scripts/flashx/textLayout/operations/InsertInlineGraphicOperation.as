package flashx.textLayout.operations
{
   ...
   public class InsertInlineGraphicOperation extends FlowTextOperation
   {
      ...
      override public function doOperation() : Boolean
      {
         ...
         {
            if(!((_loc7_ = this.selPos - _loc4_.getAbsoluteStart()) == 0 && !(_loc4_ as SubParagraphGroupElementBase).acceptTextBefore() || _loc7_ == _loc4_.textLength && !(_loc4_ as SubParagraphGroupElementBase).acceptTextAfter()))
            {
               break;
            }
