package flashx.textLayout.edit
{
   ...
   public class EditManager extends SelectionManager implements IEditManager
   {
            ...
            switch(param1.charCode)
            {
               ...
               case Keyboard.ENTER:
                  if(textFlow.configuration.manageEnterKey)
                  {
                     ...
                     if(_loc2_ && _loc5_.getParentByType(ListElement) != _loc2_.getParentByType(ListElement))
                     {
                        _loc2_ = null;
                     }
                     if(_loc2_ && !param1.shiftKey)
                     {
                        if(_loc2_.textLength == 1 && _loc2_.parent.getChildIndex(_loc2_) == _loc2_.parent.numChildren - 1)
                        {
                           _loc3_ = this.defaultOperationState();
                           if(!_loc3_)
                           {
                              return;
                           }
               ...
               case Keyboard.TAB:
                  if(textFlow.configuration.manageTabKey)
                  {
                     ...
                     if(_loc2_ && _loc2_.getAbsoluteStart() == absoluteStart)
                     {
                        _loc3_ = this.defaultOperationState();
                        if(!_loc3_)
                        {
      ...
      tlf_internal function endIMESession() : void
      {
         ...
         var _loc1_:IFlowComposer = !!textFlow ? textFlow.flowComposer : null;
         if(_loc1_ && _loc1_.numControllers > 1)
         {
            this.setFocus();
         }
      }
      ...
      private function finalizeDo(param1:FlowOperation) : void
      {
         ...
         if(this.parentStack && this.parentStack.length > 0)
         {
            ...
            if(_loc3_.captureLevel == this.captureLevel)
            {
      ...
      {
         param1 = this.defaultOperationState(param1);
         if(!param1)
         {
            return null;
         }
      ...
      {
         param2 = this.defaultOperationState(param2);
         if(!param2)
         {
            return null;
         }
      ...
      {
         param3 = this.defaultOperationState(param3);
         if(!param3)
         {
            return null;
         }
      ...
      {
         if(!(param6 = this.defaultOperationState(param6)))
         {
            return;
         }
      ...
      public function insertText(param1:String, param2:SelectionState = null) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param2 == null && this.pendingInsert)
         {
            this.pendingInsert.text += param1;
         }
         else
         {
            _loc3_ = this.defaultOperationState(param2);
            if(!_loc3_)
            {
               return;
            }
            ...
            if(this.captureLevel == 0 && param2 == null && _loc4_ && _loc4_.container && this.allowDelayedOperations)
            {
      ...
      {
         if(!(param5 = this.defaultOperationState(param5)))
         {
            return null;
         }
      ...
      {
         if(!(param4 = this.defaultOperationState(param4)))
         {
            return;
         }
      ...
      public function beginCompositeOperation() : void
      {
         ...
         if(!this._imeSession)
         {
            _loc3_ = new FlowOperationEvent(FlowOperationEvent.FLOW_OPERATION_BEGIN,false,false,_loc1_,this.captureLevel,null);
            textFlow.dispatchEvent(_loc3_);
         }
         _loc1_.setGenerations(textFlow.generation,0);
         ++this.captureLevel;
         var _loc2_:Object = new Object();
         _loc2_.operation = _loc1_;
         _loc2_.captureLevel = this.captureLevel;
      ...
      public function endCompositeOperation() : void
      {
         ...
         if(!this._imeSession)
         {
            _loc3_ = new FlowOperationEvent(FlowOperationEvent.FLOW_OPERATION_END,false,false,_loc2_,this.captureLevel,null);
            textFlow.dispatchEvent(_loc3_);
         }
         _loc2_.setGenerations(_loc2_.beginGeneration,textFlow.generation);
      ...
      override tlf_internal function selectionChanged(param1:Boolean = true, param2:Boolean = true) : void
      {
         ...
         super.selectionChanged(param1,param2);
      }
   }
}
