package flashx.textLayout.edit
{
   ...
   public class ParaEdit
   {
      ...
      public static function insertText(param1:TextFlow, param2:int, param3:String, param4:Boolean) : SpanElement
      {
         ...
         while(_loc11_ != null)
         {
            if(!((_loc14_ = _loc9_ - _loc11_.getElementRelativeStart(_loc7_)) == 0 && !_loc11_.acceptTextBefore() || !_loc11_.acceptTextAfter() && (_loc14_ == _loc11_.textLength || _loc14_ == _loc11_.textLength - 1 && _loc5_ == _loc7_.getLastLeaf())))
            {
               break;
            }
            param4 = true;
      ...
      public static function createImage(param1:FlowGroupElement, param2:int, param3:Object, param4:Object, param5:Object, param6:Object, param7:ITextLayoutFormat) : InlineGraphicElement
      {
         ...
         {
            _loc16_ = "source=";
            if((_loc17_ = _loc11_.indexOf(_loc16_,6)) > 0)
            {
               _loc17_ += _loc16_.length;
               _loc17_ = _loc11_.indexOf("\'",_loc17_);
               _loc11_ = _loc11_.substring(_loc17_ + 1,_loc11_.indexOf("\'",_loc17_ + 1));
            }
         }
         _loc10_.source = _loc11_;
         while(_loc8_ && _loc8_.parent != param1)
         {
            _loc8_ = _loc8_.parent;
         }
         var _loc13_:int = _loc8_ != null ? int(param1.getChildIndex(_loc8_)) : int(param1.numChildren);
         if(_loc8_ && _loc9_ > 0)
         {
            _loc13_++;
         }
      ...
      private static function setCharacterFormat(param1:FlowLeafElement, param2:ITextLayoutFormat, param3:int, param4:int) : int
      {
         ...
         if(!(param2 is ITextLayoutFormat) || !TextLayoutFormat.isEqual(ITextLayoutFormat(param2),param1.format))
         {
            ...
            if(_loc8_ + param4 == param1.textLength - 1 && param1 is SpanElement && SpanElement(param1).hasParagraphTerminator)
            {
               param4++;
            }
            ...
            {
               _loc9_.setStylesInternal(param2);
            }
      ...
      public static function splitElement(param1:FlowGroupElement, param2:int) : FlowGroupElement
      {
         ...
         {
            _loc4_ = _loc3_;
            while(!(_loc4_ is ParagraphElement) && _loc4_.numChildren)
            {
               _loc4_ = _loc4_.getChildAt(0) as FlowGroupElement;
            }
            _loc5_ = param1;
            while(!(_loc5_ is ParagraphElement) && _loc5_.numChildren)
            {
            ...
            {
               _loc5_.normalizeRange(0,_loc5_.textLength);
               _loc5_.getLastLeaf().quickCloneTextLayoutFormat(_loc4_.getFirstLeaf());
            }
            else if(_loc4_.textLength <= 1)
            {
               _loc4_.normalizeRange(0,_loc4_.textLength);
               _loc4_.getFirstLeaf().quickCloneTextLayoutFormat(_loc5_.getLastLeaf());
            }
         }
         return _loc3_;
      }
