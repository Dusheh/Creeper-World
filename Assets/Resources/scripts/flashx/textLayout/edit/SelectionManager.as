package flashx.textLayout.edit
{
   ...
   public class SelectionManager implements ISelectionManager
   {
      ...
      private static function computeSelectionIndexInContainer(param1:TextFlow, param2:ContainerController, param3:Number, param4:Number) : int
      {
         ...
         var _loc11_:Number = !!_loc9_ ? Number(param3) : Number(param4);
         ...
         while(_loc18_ >= 0)
         {
            ...
            else if(!(_loc16_.absoluteStart < _loc6_ || _loc16_.absoluteStart >= _loc6_ + _loc7_))
            {
               if(!((_loc17_ = _loc16_.getTextLine()) == null || _loc17_.parent == null))
               {
                  ...
                  _loc26_ = !!_loc9_ ? Number(_loc25_.left) : Number(_loc25_.bottom);
                  _loc27_ = -1;
                  if(_loc13_)
                  {
                     _loc29_ = !!_loc9_ ? Number(_loc13_.right) : Number(_loc13_.top);
                     _loc27_ = Number((_loc26_ + _loc29_) / 2);
                  }
         ...
         if(!_loc9_)
         {
            ...
            else if(param3 > _loc23_.x + _loc23_.width)
            {
               ...
               {
                  param3 = Number(_loc23_.x + _loc23_.width);
               }
            }
         }
         else if(param4 < 0)
         ...
         else if(param4 > _loc23_.y + _loc23_.height)
         {
            ...
            {
               param4 = Number(_loc23_.y + _loc23_.height);
            }
         }
         var _loc24_:int;
      ...
      private static function computeSelectionIndexInLine(param1:TextFlow, param2:TextLine, param3:Number, param4:Number) : int
      {
         ...
         var _loc7_:Number = param1.computedFormat.blockProgression == BlockProgression.RL ? Number(param3) : Number(param4);
         var _loc8_:Point;
            ...
            else
            {
               ...
               while(_loc18_ < param1.flowComposer.numControllers)
               {
                  ...
                  if(checkForDisplayed(_loc19_.container as DisplayObject))
                  {
                     ...
                     _loc21_ = !!isNaN(_loc19_.compositionWidth) ? Number(_loc19_.getTotalPaddingLeft() + _loc20_.width) : Number(_loc19_.compositionWidth);
                     _loc22_ = !!isNaN(_loc19_.compositionHeight) ? Number(_loc19_.getTotalPaddingTop() + _loc20_.height) : Number(_loc19_.compositionHeight);
                     _loc7_ = DisplayObject(param2).localToGlobal(new Point(param4,param5));
                     ...
                     {
                        _loc7_.x -= _loc23_ = Number(_loc19_.container.scrollRect.x);
                        _loc7_.y -= _loc24_ = Number(_loc19_.container.scrollRect.y);
                     }
                     ...
                     if(_loc7_.x < 0)
                     {
                        _loc25_ = Number(_loc7_.x);
                        if(_loc7_.y < 0)
                        {
                           _loc26_ = Number(_loc7_.y);
                        }
                        else if(_loc7_.y > _loc22_)
                        {
                           _loc26_ = Number(_loc7_.y - _loc22_);
                        }
                     }
                     else if(_loc7_.x > _loc21_)
                     {
                        _loc25_ = Number(_loc7_.x - _loc21_);
                        if(_loc7_.y < 0)
                        {
                           _loc26_ = Number(_loc7_.y);
                        }
               ...
               _loc6_ = !!_loc14_ ? int(computeSelectionIndexInContainer(param1,_loc14_,_loc15_,_loc16_)) : -1;
            }
         }
      ...
      private function selectionPoint(param1:Object, param2:InteractiveObject, param3:Number, param4:Number, param5:Boolean = false) : SelectionState
      {
         ...
         if((_loc7_ = computeSelectionIndex(this._textFlow,param2,param1,param3,param4)) == -1)
         {
            return null;
         }
      ...
      public function mouseDoubleClickHandler(param1:MouseEvent) : void
      {
         ...
         {
            _loc7_ = (_loc6_ = this._textFlow.findAbsoluteParagraph(this.anchorMark.position)).getAbsoluteStart();
