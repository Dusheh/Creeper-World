   ...
   public class TextFlowEdit
   {
      ...
      public static function insertTextScrap(param1:TextFlow, param2:int, param3:TextScrap, param4:Boolean) : int
      {
         ...
         while(_loc6_)
         {
            ...
            _loc8_ = !!(_loc7_ = _loc11_ is FlowLeafElement ? FlowLeafElement(_loc11_).getNextLeaf() : FlowGroupElement(_loc11_).getLastLeaf().getNextLeaf()) ? int(_loc7_.getAbsoluteStart()) : int(param1.textLength - 1);
      ...
      public static function makeTCY(param1:TextFlow, param2:int, param3:int) : Boolean
      {
         ...
         var _loc5_:*;
         if(!(_loc5_ = param1.findAbsoluteParagraph(param2)))
         {
            return false;
         }
         while(_loc5_)
      ...
      public static function makeLink(param1:TextFlow, param2:int, param3:int, param4:String, param5:String) : Boolean
      {
         ...
         var _loc7_:*;
         if(!(_loc7_ = param1.findAbsoluteParagraph(param2)))
         {
            return false;
         }
         while(_loc7_)
      ...
      tlf_internal static function canInsertSPBlock(param1:TextFlow, param2:int, param3:int, param4:Class) : Boolean
      {
         ...
         if((_loc5_ = param1.findAbsoluteFlowGroupElement(param2)).getParentByType(param4))
         {
            _loc5_ = _loc5_.getParentByType(param4) as FlowGroupElement;
         }
         var _loc6_:FlowGroupElement;
         if((_loc6_ = param1.findAbsoluteFlowGroupElement(param3 - 1)).getParentByType(param4))
         {
