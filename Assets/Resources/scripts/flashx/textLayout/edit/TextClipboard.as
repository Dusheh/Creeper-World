package flashx.textLayout.edit
{
   ...
   public class TextClipboard
   {
      ...
      tlf_internal static function exportScrap(param1:TextScrap, param2:Function) : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            if((_loc6_ = TextConverter.getFormatDescriptorAt(_loc5_)).clipboardFormat && _loc3_.indexOf(_loc6_.clipboardFormat) < 0)
            {
               if(_loc7_ = exportForClipboard(param1,_loc6_.format))
               {
