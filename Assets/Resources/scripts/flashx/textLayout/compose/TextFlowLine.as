package flashx.textLayout.compose
{
   ...
   public final class TextFlowLine implements IVerticalJustificationLine
   {
      ...
      tlf_internal static function initializeNumberLinePosition(param1:TextLine, param2:ListItemElement, param3:ParagraphElement, param4:Number) : void
      {
         ...
         var _loc7_:Number = _loc5_.paragraphEndIndent === undefined || param2.computedFormat.listStylePosition == ListStylePosition.INSIDE ? 0 : (_loc5_.paragraphEndIndent == FormatValue.INHERIT ? Number(_loc6_.paragraphEndIndent) : Number(_loc5_.paragraphEndIndent));
      ...
      tlf_internal function initialize(param1:ParagraphElement, param2:Number = 0, param3:Number = 0, param4:int = 0, param5:int = 0, param6:TextLine = null) : void
      {
         ...
         if(param6)
         {
            ...
            this.setFlag(!!param6.hasGraphicElement ? uint(GRAPHICELEMENT_MASK) : uint(0),GRAPHICELEMENT_MASK);
         }
         else
         {
      ...
      public function get location() : int
      {
         ...
         if(this._para)
         {
            ...
            if(_loc1_ == 0)
            {
               return this._textLength == this._para.textLength ? 0 : int(TextFlowLineLocation.FIRST);
            }
      ...
      {
         return !!(this.location & 0) ? Number(this._para.computedFormat.paragraphSpaceBefore) : Number(0);
      }
      
      public function get spaceAfter() : Number
      {
         return !!(this.location & 0) ? Number(this._para.computedFormat.paragraphSpaceAfter) : Number(0);
      }
      ...
      tlf_internal function recreateTextLine(param1:TextBlock, param2:TextLine) : TextLine
      {
         ...
         if(this.hasNumberLine)
         {
            ...
            if(_loc8_ = TextFlowLine.createNumberLine(this._para.getParentByType(ListItemElement) as ListItemElement,this._para,_loc6_.swfContext,_loc10_))
            {
               if(getNumberLineListStylePosition(_loc8_) == ListStylePosition.INSIDE)
               {
                  _loc9_ += getNumberLineInsideLineWidth(_loc8_);
               }
            }
         }
      ...
      tlf_internal function createAdornments(param1:String, param2:FlowLeafElement, param3:int, param4:TextLine, param5:TextLine) : void
      {
         ...
         if(param5)
         {
            ...
            {
               if(_loc7_ = param2.getTextFlow().getBackgroundManager())
               {
         ...
         while(true)
         {
            this._adornCount += param2.updateAdornments(param4,param1);
      ...
      tlf_internal function getLineLeading(param1:String, param2:FlowLeafElement, param3:int) : Number
      {
         ...
         while(true)
         {
            if(!(_loc6_ = param2.getEffectiveLineHeight(param1)) && param2.textLength == this.textLength)
            {
            ...
            _loc5_ = Number(Math.max(_loc5_,_loc6_));
            param3 += param2.textLength;
            if(param3 >= _loc4_)
            {
               break;
      ...
      private function getSelectionShapesCacheEntry(param1:int, param2:int, param3:TextFlowLine, param4:TextFlowLine, param5:String) : SelectionCache
      {
         ...
         if((_loc7_ = _selectionBlockCache["[object TextFlowLine]"]) && _loc7_.begIdx == param1 && _loc7_.endIdx == param2)
         {
            return _loc7_;
         }
         ...
         if(_loc7_ == null)
         {
            ...
            _selectionBlockCache["[object TextFlowLine]"] = _loc7_;
         }
         else
         {
            _loc7_.clear();
      ...
      tlf_internal function calculateSelectionBounds(param1:TextLine, param2:Array, param3:int, param4:int, param5:String, param6:Array) : void
      {
         ...
         while(_loc9_ < param4)
         {
            ...
            else if(_loc10_ is InlineGraphicElement && (_loc10_ as InlineGraphicElement).computedFloat != Float.NONE)
            {
               if(_loc13_ == null)
               {
                  _loc13_ = new Array();
               ...
               if(_loc18_ = this.controller.getFloatAtPosition(_loc8_ + _loc9_))
               {
            ...
            else
            {
               ...
               else
               {
                  ...
                  _loc25_ = 0;
                  _loc26_ = param4 < _loc23_ ? int(param4) : int(_loc23_);
                  _loc27_ = new Array();
         ...
         if(_loc12_.length > 0 && _loc8_ + param3 == this.absoluteStart && _loc8_ + param4 == this.absoluteStart + this.textLength)
         {
            ...
            {
               if((_loc31_ = this._para.getCharCodeAtPosition(_loc16_ - 1)) != SpanElement.kParagraphTerminator.charCodeAt(0) && CharacterUtil.isWhitespace(_loc31_))
               {
      ...
      private function createSelectionShapes(param1:Shape, param2:SelectionFormat, param3:DisplayObject, param4:int, param5:int, param6:TextFlowLine, param7:TextFlowLine) : void
      {
         ...
         var _loc9_:String = (_loc8_ = this._para.getAncestorWithContainer()).computedFormat.blockProgression;
         ...
         {
            if((_loc13_ = this._para.getTextFlow().interactionManager) && _loc13_.anchorPosition == _loc13_.activePosition)
            {
      ...
      tlf_internal function getRomanSelectionHeightAndVerticalAdjustment(param1:TextFlowLine, param2:TextFlowLine) : Array
      {
         ...
         {
            _loc3_ = Number(Math.max(this.height,this.textHeight));
         }
         else
         {
            _loc5_ = !param1 || param1.controller != this.controller || param1.columnIndex != this.columnIndex;
            if(_loc6_ = !param2 || param2.controller != this.controller || param2.columnIndex != this.columnIndex || param2.paragraph.getEffectiveLeadingModel() == LeadingModel.ROMAN_UP)
            {
               if(!_loc5_)
               {
                  _loc3_ = Number(this.textHeight);
               }
               else
               {
                  _loc3_ = Number(Math.max(this.height,this.textHeight));
            ...
            {
               _loc3_ = Number(Math.max(param2.height,this.textHeight));
               _loc4_ = Number(_loc3_ - this.textHeight);
            }
            else
            {
               _loc7_ = this._descent - Math.max(this.height,this.textHeight);
               _loc3_ = Number((_loc8_ = Math.max(param2.height,this.textHeight) - this._ascent) - _loc7_);
               _loc4_ = Number(_loc8_ - this._descent);
            }
         }
         if(!param1 || param1.columnIndex != this.columnIndex || param1.controller != this.controller)
         {
            _loc3_ += this.descent;
            _loc4_ = Number(Math.floor(this.descent / 2));
         }
      ...
      private function makeSelectionBlocks(param1:TextLine, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Array) : Array
      {
         ...
         var _loc14_:Boolean = _loc12_ != -1 ? Boolean(this.isAtomBidi(param1,_loc12_,param6)) : false;
         var _loc15_:Boolean = _loc13_ != -1 ? Boolean(this.isAtomBidi(param1,_loc13_,param6)) : false;
         if(_loc14_ || _loc15_)
         {
            _loc18_ = param2;
         ...
         {
            if(!(_loc25_ = _loc10_ as InlineGraphicElement) || _loc25_.effectiveFloat == Float.NONE || param2 == param3)
            {
      ...
      private function makeBlock(param1:TextLine, param2:int, param3:int, param4:int, param5:Rectangle, param6:String, param7:String, param8:Array) : Rectangle
      {
         ...
         {
            _loc10_.y = _loc11_.y;
            _loc9_.height = param3 != param4 ? Number(_loc12_.bottom - _loc11_.top) : Number(_loc11_.height);
         ...
         else
         {
            ...
            if(_loc13_ != JustificationRule.EAST_ASIAN)
            {
               ...
               _loc9_.width = param3 != param4 ? Number(Math.abs(_loc12_.right - _loc11_.left)) : Number(_loc11_.width);
            }
            else
            {
      ...
      tlf_internal function hiliteBlockSelection(param1:Shape, param2:SelectionFormat, param3:DisplayObject, param4:int, param5:int, param6:TextFlowLine, param7:TextFlowLine) : void
      {
         ...
         var _loc8_:TextLine;
         if(!(_loc8_ = this.peekTextLine()) || !_loc8_.parent)
         {
            return;
         }
      ...
      tlf_internal function hilitePointSelection(param1:SelectionFormat, param2:int, param3:DisplayObject, param4:TextFlowLine, param5:TextFlowLine) : void
      {
         ...
         if(_loc6_ = this.computePointSelectionRectangle(param2,param3,param4,param5,true))
         {
      ...
      tlf_internal function computePointSelectionRectangle(param1:int, param2:DisplayObject, param3:TextFlowLine, param4:TextFlowLine, param5:Boolean) : Rectangle
      {
         ...
         var _loc6_:TextLine;
         if(!(_loc6_ = this.peekTextLine()) || !_loc6_.parent)
         {
            return null;
         }
         ...
         var _loc12_:String = (_loc11_ = this._para.getAncestorWithContainer()).computedFormat.blockProgression;
         ...
         if(_loc12_ == BlockProgression.RL && _loc6_.getAtomTextRotation(_loc8_) != TextRotation.ROTATE_0)
         {
            ...
            _loc19_ = (_loc19_ = _loc18_.y - _loc21_.y) == 0 ? 1 : Number(Math.abs(1 / _loc19_));
            if(!_loc17_)
            {
            ...
            {
               setRectangleValues(_loc16_,_loc16_.x,!_loc9_ ? Number(_loc16_.y + _loc16_.height) : Number(_loc16_.y),_loc16_.width,_loc19_);
            }
         }
         else
         {
            _loc22_ = param2.localToGlobal(localOnePoint);
            _loc19_ = (_loc19_ = _loc18_.x - _loc22_.x) == 0 ? 1 : Number(Math.abs(1 / _loc19_));
            if(!_loc17_)
            {
            ...
            {
               setRectangleValues(_loc16_,!_loc9_ ? Number(_loc16_.x + _loc16_.width) : Number(_loc16_.x),_loc16_.y,_loc19_,_loc16_.height);
            }
         }
      ...
      tlf_internal function selectionWillIntersectScrollRect(param1:Rectangle, param2:int, param3:int, param4:TextFlowLine, param5:TextFlowLine) : int
      {
         ...
         var _loc7_:String = (_loc6_ = this._para.getAncestorWithContainer()).computedFormat.blockProgression;
         var _loc8_:TextLine = this.getTextLine(true);
         if(param2 == param3)
         {
            if(_loc9_ = this.computePointSelectionRectangle(param2,DisplayObject(this.controller.container),param4,param5,false))
            {
   ...
   tlf_internal static function calculateInsideNumberLineWidth(param1:TextLine, param2:String) : Number
   {
      ...
      if(param2 == BlockProgression.TB)
      {
         while(_loc5_ < param1.atomCount)
         {
            if(param1.getAtomTextBlockBeginIndex(_loc5_) != param1.rawTextLength - 1)
            {
               ...
               _loc3_ = Number(Math.min(_loc3_,_loc6_.x));
               _loc4_ = Number(Math.max(_loc4_,_loc6_.right));
            }
            _loc5_++;
         }
      }
      else
      {
         while(_loc5_ < param1.atomCount)
         {
            ...
            {
               _loc6_ = param1.getAtomBounds(_loc5_);
               _loc3_ = Number(Math.min(_loc3_,_loc6_.top));
               _loc4_ = Number(Math.max(_loc4_,_loc6_.bottom));
            }
            _loc5_++;
         }
      }
      param1.flushAtomData();
      return _loc4_ > _loc3_ ? Number(_loc4_ - _loc3_) : Number(0);
   }
