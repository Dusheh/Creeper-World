      ...
      public static function applyVerticalAlignmentToColumn(param1:ContainerController, param2:String, param3:Array, param4:int, param5:int, param6:int, param7:int) : Number
      {
         ...
         switch(param2)
         {
            ...
            case VerticalAlign.BOTTOM:
               ...
               _loc10_ = param2 == VerticalAlign.MIDDLE ? Number(_loc8_.computeMiddleAdjustment(_loc12_)) : Number(_loc8_.computeBottomAdjustment(_loc12_));
               _loc9_ = param4;
               ...
               {
                  if((_loc14_ = param1.getFloatAt(_loc13_)).floatType != Float.NONE)
                  {
...
class TB_VJHelper implements IVerticalAdjustmentHelper
{
   ...
   public function getBottom(param1:IVerticalJustificationLine, param2:ContainerController, param3:int, param4:int) : Number
   {
      ...
      while(_loc6_ < param4)
      {
         if((_loc7_ = param2.getFloatAt(_loc6_)).floatType != Float.NONE)
         {
   ...
   public function computeJustifyAdjustment(param1:Array, param2:int, param3:int) : Number
   {
      ...
      var _loc8_:Number;
      var _loc7_:Number;
      if((_loc8_ = (_loc7_ = this._textFrame.compositionHeight - Number(this._textFrame.getTotalPaddingBottom())) - this.getBottomOfLine(_loc6_)) < 0)
      {
         return 0;
      }
   ...
   public function applyJustifyAdjustment(param1:Array, param2:int, param3:int) : void
   {
      ...
      var _loc4_:IVerticalJustificationLine = param1[param2];
      var _loc5_:Number;
      var _loc6_:Number = _loc5_ = this.getBaseline(_loc4_);
      var _loc10_:int = 1;
...
class RL_VJHelper implements IVerticalAdjustmentHelper
{
   ...
   public function getBottom(param1:IVerticalJustificationLine, param2:ContainerController, param3:int, param4:int) : Number
   {
      var _loc8_:* = null;
      var _loc5_:Number;
      var _loc6_:Number = (_loc5_ = this._textFrame.compositionWidth - Number(this._textFrame.getTotalPaddingLeft())) + param1.x - param1.descent;
      var _loc7_:int = param3;
      while(_loc7_ < param4)
      {
         if((_loc8_ = param2.getFloatAt(_loc7_)).floatType != Float.NONE)
         {
