package flashx.textLayout.compose
{
   ...
   public class FlowComposerBase
   {
      ...
      public function updateLengths(param1:int, param2:int) : void
      {
         ...
         else
         {
            ...
            do
            {
               ...
               _loc7_ = param1 > _loc3_.absoluteStart ? int(param1) : int(_loc3_.absoluteStart);
         ...
         while(_loc4_ < this._lines.length)
         {
            ...
            {
               _loc3_.setAbsoluteStart(_loc3_.absoluteStart > -param2 ? int(_loc3_.absoluteStart + param2) : 0);
            }
            _loc4_++;
         }
      ...
      public function damage(param1:int, param2:int, param3:String) : void
      {
         ...
         if((_loc5_ = this.textFlow.findLeaf(param1)) && _loc4_ > 0)
         {
            _loc4_--;
         }
      ...
      public function addLine(param1:TextFlowLine, param2:int) : void
      {
         ...
         else if(_loc3_.absoluteStart != param1.absoluteStart)
         {
            ...
            {
               (_loc4_ = new TextFlowLine(null,param1.paragraph)).setAbsoluteStart(param1.absoluteStart + param1.textLength);
            ...
            {
               _loc3_.setTextLength(param1.absoluteStart - _loc3_.absoluteStart);
               (_loc4_ = this._lines[param2 + 1]).setTextLength(param1.absoluteStart + param1.textLength - _loc4_.absoluteStart);
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  if((_loc12_ = TextFlowLine(this._lines[_loc11_]).peekTextLine()) && !_loc12_.parent)
                  {
