package flashx.textLayout.compose
{
   ...
   public class ParcelList
   {
      ...
      protected function addOneControllerToParcelList(param1:ContainerController) : void
      {
         ...
         {
            if(!(_loc4_ = _loc2_.getColumnAt(_loc3_)).isEmpty())
            {
      ...
      private function adjustForScroll(param1:ContainerController, param2:Boolean) : void
      {
         ...
         if(this._verticalText)
         {
            ...
            {
               if(_loc5_ = this.getParcelAt(this._numParcels - 1))
               {
      ...
      {
         this._insideListItemMargin += param1;
      }
      ...
      {
         if(this.currentParcel.getLineSlug(param1,this._totalDepth,param2,param3,!!this.currentParcel.fitAny ? 1 : Number(int(param2)),this._leftMargin,this._rightMargin,param4 + this._insideListItemMargin,param5,this._explicitLineBreaks))
         {
      ...
      {
         return this.currentParcel.getLineSlug(param1,param2,param4,param3,!!this.currentParcel.fitAny ? 1 : Number(int(param4)),this._leftMargin,this._rightMargin,0,true,this._explicitLineBreaks);
      }
   }
}
