package flashx.textLayout.formats
{
   ...
   public class ListMarkerFormat extends TextLayoutFormat implements IListMarkerFormat
   {
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,param2,param3,param4)).addHandlers(Property.sharedUndefinedHandler,new EnumPropertyHandler([FormatValue.NONE]),new CounterPropHandler(0));
         return _loc5_;
      }
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,param2,param3,param4)).addHandlers(Property.sharedUndefinedHandler,new EnumPropertyHandler([FormatValue.NONE]),new CounterPropHandler(1));
         return _loc5_;
      }
      ...
      {
         var _loc5_:Property;
         (_loc5_ = new Property(param1,param2,param3,param4)).addHandlers(Property.sharedUndefinedHandler,new EnumPropertyHandler([FormatValue.NONE]),new CounterContentHandler());
         return _loc5_;
      }
