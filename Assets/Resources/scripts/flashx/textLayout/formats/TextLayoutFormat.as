package flashx.textLayout.formats
{
   ...
   public class TextLayoutFormat implements ITextLayoutFormat
   {
      ...
      public static function isEqual(param1:ITextLayoutFormat, param2:ITextLayoutFormat) : Boolean
      {
         ...
         if(param1 == null)
         {
            param1 = tlf_internal::emptyTextLayoutFormat;
         }
         if(param2 == null)
         {
            param2 = tlf_internal::emptyTextLayoutFormat;
         }
         if(param1 == param2)
         {
            return true;
      ...
      {
         if(tlf_internal::description.hasOwnProperty(param1))
         {
            this[param1] = param2;
         }
         else
      ...
      public function copy(param1:ITextLayoutFormat) : void
      {
         ...
         if(param1)
         {
            ...
            {
               if((_loc4_ = param1[_loc3_.name]) !== undefined)
               {
      ...
      public function concat(param1:ITextLayoutFormat) : void
      {
         ...
         if(_loc2_)
         {
            ...
            {
               _loc3_ = tlf_internal::description[_loc5_];
               if(_loc3_)
               {
      ...
      public function removeMatching(param1:ITextLayoutFormat) : void
      {
         ...
         if(_loc3_)
         {
            ...
            for(_loc5_ in _loc4_)
            {
               _loc2_ = tlf_internal::description[_loc5_];
               if(_loc2_)
               {
