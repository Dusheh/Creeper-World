package flashx.textLayout.utils
{
   ...
   public final class NavigationUtil
   {
      ...
      private static function previousAtomHelper(param1:TextFlow, param2:ParagraphElement, param3:int, param4:int) : int
      {
         if(param3 - param4 == 0)
         {
            return param3 > 0 ? int(param3 - 1) : 0;
         }
      ...
      public static function previousWordPosition(param1:TextFlow, param2:int) : int
      {
         ...
         if(param2 - _loc4_ == 0)
         {
            return param2 > 0 ? int(param2 - 1) : 0;
         }
         do
         {
      ...
      tlf_internal static function computeEndIdx(param1:TextFlowLine, param2:TextFlowLine, param3:String, param4:Boolean, param5:Point) : int
      {
         ...
         if((_loc10_ = _loc7_.getAtomIndexAtPoint(param5.x,param5.y)) == -1)
         {
            if(param3 != BlockProgression.RL)
            {
               if(!_loc9_)
               {
                  _loc6_ = param5.x <= _loc7_.x ? int(param1.absoluteStart) : int(param1.absoluteStart + param1.textLength - 1);
               }
               else
               {
                  _loc6_ = param5.x <= _loc7_.x ? int(param1.absoluteStart + param1.textLength - 1) : int(param1.absoluteStart);
               }
            }
            else if(!_loc9_)
            {
               _loc6_ = param5.y <= _loc7_.y ? int(param1.absoluteStart) : int(param1.absoluteStart + param1.textLength - 1);
            }
            else
            {
               _loc6_ = param5.y <= _loc7_.y ? int(param1.absoluteStart + param1.textLength - 1) : int(param1.absoluteStart);
            }
         }
         else
         {
            ...
            {
               _loc15_ = !!_loc14_ ? int(_loc7_.getAtomTextBlockBeginIndex(_loc10_)) : int(_loc7_.getAtomTextBlockEndIndex(_loc10_));
            }
            else if(param4)
            {
            ...
            {
               _loc15_ = !!_loc14_ ? int(_loc7_.getAtomTextBlockEndIndex(_loc10_)) : int(_loc7_.getAtomTextBlockBeginIndex(_loc10_));
            }
         ...
         if(_loc8_ < _loc3_.flowComposer.numLines - 1)
         {
            ...
            if(_loc22_.absoluteStart >= _loc24_ && _loc22_.absoluteStart < _loc25_)
            {
               if(_loc22_.isDamaged())
               {
                  ...
                  if((_loc22_ = _loc3_.flowComposer.getLineAt(_loc8_ + 1)).isDamaged())
                  {
                     return false;
                  }
               }
               _loc26_ = _loc4_ == BlockProgression.TB ? Number(_loc23_.horizontalScrollPosition) : Number(_loc23_.verticalScrollPosition);
            ...
            if((_loc6_ = computeEndIdx(_loc22_,_loc10_,_loc4_,_loc9_,_loc21_)) >= _loc3_.textLength)
            {
      ...
      public static function previousLine(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ > 0)
         {
            ...
            {
               _loc24_ = _loc4_ == BlockProgression.TB ? Number(_loc21_.horizontalScrollPosition) : Number(_loc21_.verticalScrollPosition);
