package flashx.textLayout.utils
{
   ...
   public final class GeometryUtil
   {
      ...
      public static function getHighlightBounds(param1:TextRange) : Array
      {
         ...
         var _loc5_:int;
         if((_loc5_ = param1.absoluteStart == param1.absoluteEnd ? int(_loc4_) : int(_loc2_.findLineIndexAtPosition(param1.absoluteEnd))) >= _loc2_.numLines)
         {
         ...
         while(_loc10_ <= _loc5_)
         {
            ...
            _loc8_.calculateSelectionBounds(_loc12_,_loc9_,param1.absoluteStart < _loc8_.absoluteStart ? int(_loc8_.absoluteStart - _loc8_.paragraph.getAbsoluteStart()) : int(param1.absoluteStart - _loc8_.paragraph.getAbsoluteStart()),param1.absoluteEnd > _loc8_.absoluteStart + _loc8_.textLength ? int(_loc8_.absoluteStart + _loc8_.textLength - _loc8_.paragraph.getAbsoluteStart()) : int(param1.absoluteEnd - _loc8_.paragraph.getAbsoluteStart()),param1.textFlow.computedFormat.blockProgression,_loc11_);
