package flashx.textLayout.conversion
{
   ...
   public class TextFieldHtmlImporter extends BaseTextLayoutImporter implements IHTMLImporter
   {
      ...
      public static function parseSpan(param1:TextFieldHtmlImporter, param2:XML, param3:FlowGroupElement) : void
      {
         ...
         var _loc6_:String;
         if((_loc6_ = extractSimpleSpanText(param2)) == null)
         {
            if(_loc4_ !== undefined || _loc5_ !== undefined || !TextLayoutFormat.isEqual(tlf_internal::_activeFormat,TextLayoutFormat.emptyTextLayoutFormat))
            {
      ...
      override protected function importFromXML(param1:XML) : TextFlow
      {
         ...
         this._baseFontSize = _loc2_.fontSize === undefined ? 12 : Number(_loc2_.fontSize);
      ...
      protected function createInlineGraphicFromXML(param1:XML) : InlineGraphicElement
      {
         ...
         _loc2_.height = InlineGraphicElement.heightPropertyDefinition.setHelper(_loc2_.height,tlf_internal::_ilgFormatImporter.getFormatValue("HEIGHT"));
         _loc2_.width = InlineGraphicElement.heightPropertyDefinition.setHelper(_loc2_.width,tlf_internal::_ilgFormatImporter.getFormatValue("WIDTH"));
         var _loc5_:String;
      ...
      override protected function handleUnknownElement(param1:String, param2:XML, param3:FlowGroupElement) : void
      {
         ...
         if(_loc5_ !== undefined || _loc6_ !== undefined || !TextLayoutFormat.isEqual(tlf_internal::_activeFormat,TextLayoutFormat.emptyTextLayoutFormat) || param3 is ListElement)
         {
            _loc4_ = param3 is ParagraphElement || param3 is SubParagraphGroupElementBase ? new SubParagraphGroupElement() : new DivElement();
         ...
         {
            if((_loc8_ = param3.getChildAt(_loc7_)).id == null && _loc8_.styleName == null && _loc8_.typeName == _loc8_.defaultTypeName)
            {
