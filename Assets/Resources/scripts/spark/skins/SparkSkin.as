package spark.skins
{
   ...
   public class SparkSkin extends Skin
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc11_:* = null;
         var _loc4_:Array;
         if((_loc4_ = this.symbolItems) && _loc4_.length > 0)
         {
            _loc7_ = uint(getStyle("symbolColor"));
            _loc3_ = 0;
         ...
         var _loc5_:Array;
         if((_loc5_ = this.contentItems) && _loc5_.length > 0)
         {
            _loc8_ = uint(getStyle("contentBackgroundColor"));
         ...
         if(((_loc6_ = getStyle("chromeColor")) != DEFAULT_COLOR || this.colorized) && this.useChromeColor)
         {
            ...
            if((_loc10_ = this.colorizeExclusions) && _loc10_.length > 0)
            {
               ...
               {
                  if((_loc11_ = this[_loc10_[_loc3_]]) && (_loc11_ is DisplayObject || _loc11_ is GraphicElement))
                  {
