package spark.components
{
   ...
   public class Application extends SkinnableContainer
   {
      ...
      public function get aspectRatio() : String
      {
         ...
         if(this.isSoftKeyboardActive && mx_internal::softKeyboardBehavior == "none" && this.resizeForSoftKeyboard)
         {
      ...
      private function stage_orientationChangingHandler(param1:Event) : void
      {
         ...
         {
            _loc6_ = !!stage ? Number(0 / this.scaleFactor) : Number(height);
            _loc7_ = width;
         }
      ...
      {
         if(false && this.isSoftKeyboardActive)
         {
