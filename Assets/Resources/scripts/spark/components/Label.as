package spark.components
{
   ...
   public class Label extends TextBase
   {
      ...
      private function createTextLinesFromTextBlock(param1:TextBlock, param2:Vector.<DisplayObject>, param3:Rectangle) : Boolean
      {
         ...
         var _loc19_:Number = _loc5_ == "explicit" ? 0 : Number(_loc16_);
         ...
         while(true)
         {
            ...
            _loc27_.y = _loc26_;
            _loc22_ = Number(Math.max(_loc22_,_loc27_.textWidth));
         ...
         while(_loc48_ < _loc24_)
         {
            ...
            _loc46_ = Number(Math.max(_loc46_,_loc27_.x + _loc27_.textWidth));
            _loc48_++;
         }
      ...
      private function getNextTruncationPosition(param1:int, param2:int) : int
      {
         ...
         return int(_loc3_.getAtomTextBlockBeginIndex(_loc4_));
      }
