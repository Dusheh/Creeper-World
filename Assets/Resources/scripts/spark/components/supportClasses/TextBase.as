package spark.components.supportClasses
{
   ...
   public class TextBase extends UIComponent implements IDisplayText
   {
      ...
      override public function get baselinePosition() : Number
      {
         ...
         return this.textLines.length > 0 ? Number(this.textLines[0].y) : Number(0);
      }
      ...
      mx_internal function isTextOverset(param1:Number, param2:Number) : Boolean
      {
         ...
         return Boolean((_loc4_ = this.bounds).top < _loc3_.top || _loc4_.left < _loc3_.left || !isNaN(_loc3_.bottom) && _loc4_.bottom > _loc3_.bottom || !isNaN(_loc3_.right) && _loc4_.right > _loc3_.right);
      }
