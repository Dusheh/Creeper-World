package spark.components.supportClasses
{
   ...
   public class GroupBase extends UIComponent implements IViewport
   {
      ...
      public function get horizontalScrollPosition() : Number
      {
         ...
         if(this._layoutProperties && this._layoutProperties.horizontalScrollPosition !== undefined)
         {
      ...
      public function get verticalScrollPosition() : Number
      {
         ...
         if(this._layoutProperties && this._layoutProperties.verticalScrollPosition !== undefined)
         {
      ...
      public function get clipAndEnableScrolling() : Boolean
      {
         ...
         if(this._layoutProperties && this._layoutProperties.clipAndEnableScrolling !== undefined)
         {
      ...
      {
         super.addChildAt(param1.object,param1.index + numChildren - this._overlay.numDisplayObjects + 1);
      }
      ...
      mx_internal function drawBackground() : void
      {
         ...
         var _loc1_:Number = this._resizeMode == ResizeMode.SCALE ? Number(measuredWidth) : Number(unscaledWidth);
         var _loc2_:Number = this._resizeMode == ResizeMode.SCALE ? Number(measuredHeight) : Number(unscaledHeight);
      ...
      override protected function commitProperties() : void
      {
         ...
         if(this._overlay && this._overlay.numDisplayObjects == 0)
         {
            this.destroyOverlay();
         }
      }
      ...
      override protected function validateMatrix() : void
      {
         ...
         if(this._resizeMode == ResizeMode.SCALE)
         {
            ...
            if(measuredWidth != 0)
            {
               _loc1_ = Number(width / measuredWidth);
            }
            if(measuredHeight != 0)
            {
               _loc2_ = Number(height / measuredHeight);
            }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.luminositySettingsChanged)
         {
            ...
            if(this._mask && this._maskType == MaskType.LUMINOSITY && this._mask.filters.length > 0)
            {
               ...
               if(_loc3_ && _loc3_.shader is LuminosityMaskShader)
               {
      ...
      {
         return !!this.layout ? Number(this.layout.getHorizontalScrollPositionDelta(param1)) : Number(0);
      }
      
      public function getVerticalScrollPositionDelta(param1:uint) : Number
      {
         return !!this.layout ? Number(this.layout.getVerticalScrollPositionDelta(param1)) : Number(0);
      }
      
      mx_internal function isElementVisible(param1:ILayoutElement) : Boolean
      {
         return this.layout && this.layout.isElementVisible(param1);
      }
      ...
      override public function set mask(param1:DisplayObject) : void
      {
         ...
         {
            if(this._mask && this._mask.parent === this)
            {
