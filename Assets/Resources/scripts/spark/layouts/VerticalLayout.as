package spark.layouts
{
   ...
   public class VerticalLayout extends LayoutBase
   {
      ...
      private static function calculatePercentWidth(param1:ILayoutElement, param2:Number) : Number
      {
         ...
         return Number(LayoutElementHelper.pinBetween(Math.min(Math.round(param1.percentWidth * 0.01 * param2),param2),param1.getMinBoundsWidth(),param1.getMaxBoundsWidth()));
      }
      ...
      private function getElementWidth(param1:ILayoutElement, param2:Boolean, param3:SizesAndLimit) : void
      {
         ...
         var _loc5_:Boolean;
         var _loc6_:Number = !!(_loc5_ = !isNaN(param1.percentWidth) || param2) ? Number(Math.ceil(param1.getMinBoundsWidth())) : Number(_loc4_);
      ...
      private function getElementHeight(param1:ILayoutElement, param2:Number, param3:SizesAndLimit) : void
      {
         ...
         var _loc6_:Number = !isNaN(param1.percentHeight) ? Number(Math.ceil(param1.getMinBoundsHeight())) : Number(_loc4_);
         param3.preferredSize = _loc4_;
         param3.minSize = _loc6_;
      }
         ...
         switch(param2)
         {
            ...
            case NavigationUnit.PAGE_UP:
               ...
               while(true)
               {
                  ...
                  if((_loc6_ = this.getElementBounds(_loc5_)) && _loc6_.top < _loc7_)
                  {
            ...
            case NavigationUnit.PAGE_DOWN:
               ...
               while(true)
               {
                  ...
                  if((_loc6_ = this.getElementBounds(_loc5_)) && _loc6_.bottom > _loc7_)
                  {
      ...
      private function updateDisplayListVirtual() : void
      {
         ...
         var _loc11_:Number = this.horizontalAlign == HorizontalAlign.JUSTIFY ? Number(_loc3_) : Number(NaN);
         var _loc12_:Number = NaN;
      ...
      private function distributeHeight(param1:Number, param2:Number, param3:Number) : Number
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:* = [];
         var _loc9_:Number = !!this.variableRowHeight ? 0 : Number(Math.ceil(this.rowHeight));
         var _loc10_:int;
      ...
      override protected function calculateDropIndicatorBounds(param1:DropLocation) : Rectangle
      {
         ...
         if(false)
         {
            _loc6_ = Number(_loc2_ < _loc3_ ? Number(this.getElementBounds(_loc2_).top - _loc5_) : Number(this.getElementBounds(_loc2_ - 1).bottom + _loc4_ - _loc5_));
         }
