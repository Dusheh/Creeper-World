      ...
      override public function measure() : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            if(!(!(_loc8_ = _loc1_.getElementAt(_loc7_)) || !_loc8_.includeInLayout))
            {
               ...
               {
                  _loc16_ = (_loc16_ = !!isNaN(_loc12_) ? 0 : Number(_loc12_)) + (!!isNaN(_loc13_) ? 0 : _loc13_);
               }
               else
               {
               ...
               {
                  _loc17_ = (_loc17_ = !!isNaN(_loc14_) ? 0 : Number(_loc14_)) + (!!isNaN(_loc15_) ? 0 : _loc15_);
               }
               else
               {
               ...
               _loc2_ = Number(Math.max(_loc2_,_loc16_ + _loc18_));
               _loc3_ = Number(Math.max(_loc3_,_loc17_ + _loc19_));
               ...
               _loc4_ = Number(Math.max(_loc4_,_loc16_ + _loc20_));
               _loc5_ = Number(Math.max(_loc5_,_loc17_ + _loc21_));
            }
            _loc7_++;
         }
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         while(_loc7_ < _loc4_)
         {
            if(!(!(_loc8_ = _loc3_.getElementAt(_loc7_)) || !_loc8_.includeInLayout))
            {
               ...
               _loc5_ = Number(Math.max(_loc5_,_loc24_ + _loc22_));
               _loc6_ = Number(Math.max(_loc6_,_loc25_ + _loc23_));
            }
            _loc7_++;
         }
