package spark.layouts
{
   ...
   public class HorizontalLayout extends LayoutBase
   {
      ...
      private static function calculatePercentHeight(param1:ILayoutElement, param2:Number) : Number
      {
         ...
         return Number(LayoutElementHelper.pinBetween(Math.min(Math.round(param1.percentHeight * 0.01 * param2),param2),param1.getMinBoundsHeight(),param1.getMaxBoundsHeight()));
      }
      ...
      private static function findLayoutElementIndex(param1:GroupBase, param2:int, param3:int) : int
      {
         ...
         {
            if((_loc5_ = param1.getElementAt(param2)) && _loc5_.includeInLayout)
            {
               return param2;
            }
            param2 += param3;
      ...
      private function getElementWidth(param1:ILayoutElement, param2:Number, param3:SizesAndLimit) : void
      {
         ...
         var _loc6_:Number = !isNaN(param1.percentWidth) ? Number(Math.ceil(param1.getMinBoundsWidth())) : Number(_loc4_);
      ...
      private function getElementHeight(param1:ILayoutElement, param2:Boolean, param3:SizesAndLimit) : void
      {
         ...
         var _loc5_:Boolean;
         var _loc6_:Number = !!(_loc5_ = !isNaN(param1.percentHeight) || param2) ? Number(Math.ceil(param1.getMinBoundsHeight())) : Number(_loc4_);
         param3.preferredSize = _loc4_;
         param3.minSize = _loc6_;
      }
      ...
      private function calculateBaselineTopBottom(param1:Boolean) : Array
      {
         ...
         var _loc4_:* = 0;
         var _loc7_:Array;
         if((_loc7_ = LayoutElementHelper.parseConstraintExp(this.alignmentBaseline)).length == 2 && _loc7_[1] == "maxAscent")
         {
            _loc2_ = Number(Number(_loc7_[0]));
            _loc6_ = true;
         }
         else
         {
            _loc6_ = false;
            _loc3_ = Number(Number(_loc7_[0]));
            if(isNaN(_loc3_))
            {
               _loc3_ = 0;
               _loc6_ = true;
         ...
         while(_loc9_ < _loc8_)
         {
            ...
            {
               _loc11_ = Number(_loc10_.baseline as Number);
               if(isNaN(_loc11_))
               {
                  _loc11_ = 0;
               }
               ...
               if(_loc6_)
               {
                  _loc3_ = Number(Math.max(_loc13_,_loc3_));
               }
               if(param1)
               {
                  ...
                  _loc4_ = Number(Math.max(_loc15_,_loc4_));
               }
            }
            _loc9_++;
         }
      ...
      private function measureReal(param1:GroupBase) : void
      {
         ...
         while(_loc16_ < _loc5_)
         {
            ...
            else
            {
               if(!_loc3_)
               {
                  ...
                  _loc9_ = Number(Math.max(_loc9_,_loc2_.preferredSize));
                  _loc11_ = Number(Math.max(_loc11_,_loc2_.minSize));
               }
               if(_loc8_ < _loc14_)
               {
         ...
         if(_loc3_)
         {
            _loc20_ = (_loc19_ = this.calculateBaselineTopBottom(true))[0];
            _loc21_ = _loc19_[1];
            _loc22_ = _loc19_[2];
            _loc9_ = Number(Math.ceil(_loc20_ + _loc21_));
            _loc11_ = Number(Math.ceil(_loc20_ + _loc22_));
         }
         if(_loc8_ > 1)
         {
         ...
         switch(param2)
         {
            ...
            case NavigationUnit.PAGE_LEFT:
               ...
               while(true)
               {
                  ...
                  if((_loc6_ = this.getElementBounds(_loc5_)) && _loc6_.left < _loc7_)
                  {
            ...
            case NavigationUnit.PAGE_RIGHT:
               ...
               while(true)
               {
                  ...
                  if((_loc6_ = this.getElementBounds(_loc5_)) && _loc6_.right > _loc7_)
                  {
      ...
      private function updateDisplayListVirtual() : void
      {
         ...
         if(_loc6_ < _loc19_)
         {
            ...
            {
               _loc26_ = Number(Math.round(_loc25_ / 2));
            }
      ...
      private function updateDisplayListReal() : void
      {
         ...
         while(_loc20_ < _loc5_)
         {
            if(!(!(_loc4_ = _loc1_.getElementAt(_loc20_)) || !_loc4_.includeInLayout))
            {
               ...
               if(_loc10_)
               {
                  _loc28_ = Number(_loc4_.baseline as Number);
                  if(isNaN(_loc28_))
                  {
                     _loc28_ = 0;
                  }
      ...
      private function distributeWidth(param1:Number, param2:Number, param3:Number) : Number
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:* = [];
         var _loc10_:Number = !!this.variableColumnWidth ? 0 : Number(Math.ceil(this.columnWidth));
         var _loc11_:int;
      ...
      override protected function calculateDropIndicatorBounds(param1:DropLocation) : Rectangle
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:*;
         if((_loc4_ = Number(this.gap)) < 0 && _loc2_ == _loc3_)
         {
            _loc4_ = 0;
         }
         ...
         if(false)
         {
            _loc6_ = Number(_loc2_ < _loc3_ ? Number(this.getElementBounds(_loc2_).left - _loc5_) : Number(this.getElementBounds(_loc2_ - 1).right + _loc4_ - _loc5_));
         }
