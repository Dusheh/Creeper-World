package spark.layouts.supportClasses
{
   ...
   public class LayoutBase extends OnDemandEventDispatcher
   {
      ...
      public function getHorizontalScrollPositionDelta(param1:uint) : Number
      {
         ...
         {
            case NavigationUnit.LEFT:
               _loc7_ = Number(Math.max(_loc6_.left - _loc3_.left,-_loc3_.width));
               break;
            case NavigationUnit.RIGHT:
               _loc7_ = Number(Math.min(_loc6_.right - _loc3_.right,_loc3_.width));
               break;
            case NavigationUnit.PAGE_LEFT:
               if((_loc7_ = Number(_loc6_.right - _loc3_.right)) >= 0)
               {
                  _loc7_ = Number(Math.max(_loc6_.left - _loc3_.left,-_loc3_.width));
                  break;
               }
               break;
            case NavigationUnit.PAGE_RIGHT:
               if((_loc7_ = Number(_loc6_.left - _loc3_.left)) <= 0)
               {
                  _loc7_ = Number(Math.min(_loc6_.right - _loc3_.right,_loc3_.width));
                  break;
               }
      ...
      public function getVerticalScrollPositionDelta(param1:uint) : Number
      {
         ...
         {
            case NavigationUnit.UP:
               _loc7_ = Number(Math.max(_loc6_.top - _loc3_.top,-_loc3_.height));
               break;
            case NavigationUnit.DOWN:
               _loc7_ = Number(Math.min(_loc6_.bottom - _loc3_.bottom,_loc3_.height));
               break;
            case NavigationUnit.PAGE_UP:
               if((_loc7_ = Number(_loc6_.bottom - _loc3_.bottom)) >= 0)
               {
                  _loc7_ = Number(Math.max(_loc6_.top - _loc3_.top,-_loc3_.height));
                  break;
               }
               break;
            case NavigationUnit.PAGE_DOWN:
               if((_loc7_ = Number(_loc6_.top - _loc3_.top)) <= 0)
               {
                  _loc7_ = Number(Math.min(_loc6_.bottom - _loc3_.bottom,_loc3_.height));
                  break;
               }
      ...
      {
         return this.getScrollPositionDeltaToElementHelper(param1);
      }
      ...
      protected function getScrollPositionDeltaToElementHelperHelper(param1:Rectangle, param2:Rectangle, param3:Boolean = true, param4:Number = NaN, param5:Number = NaN, param6:Number = NaN, param7:Number = NaN) : Point
      {
         ...
         if(param3)
         {
            ...
            _loc9_ = Number(Math.abs(_loc11_) < Math.abs(_loc12_) ? Number(_loc11_) : Number(_loc12_));
            _loc10_ = Number(Math.abs(_loc13_) < Math.abs(_loc14_) ? Number(_loc13_) : Number(_loc14_));
            if(!isNaN(param4))
            {
               _loc10_ = Number(_loc13_ + param4);
            }
            else if(!isNaN(param5))
            {
               _loc10_ = Number(_loc14_ - param5);
            }
            if(!isNaN(param6))
            {
               _loc9_ = Number(_loc11_ + param6);
            }
            else if(!isNaN(param7))
            {
               _loc9_ = Number(_loc12_ - param7);
            }
         ...
         if(param2)
         {
            if(param1.width > _loc8_.width || !param3)
            {
               ...
               {
                  _loc9_ = Number(param2.left - _loc8_.left);
               }
               else if(param2.right > _loc8_.right)
               {
                  _loc9_ = Number(param2.right - _loc8_.right);
               }
            }
            if(param1.height > _loc8_.height || !param3)
            {
               ...
               {
                  _loc10_ = Number(param2.bottom - _loc8_.bottom);
               }
               else if(param2.top <= _loc8_.top)
               {
                  _loc10_ = Number(param2.top - _loc8_.top);
               }
            }
         }
      ...
      {
         var _loc8_:Rectangle = this.getChildElementBounds(param1);
         if(param2)
         {
      ...
      protected function calculateDragScrollDelta(param1:DropLocation, param2:Number) : Point
      {
         ...
         var _loc7_:Number = Math.min(this.dragScrollRegionSizeHorizontal,_loc3_.width / 2);
         var _loc8_:Number = Math.min(this.dragScrollRegionSizeVertical,_loc3_.height / 2);
         if(_loc4_.left + _loc7_ < _loc5_ && _loc5_ < _loc4_.right - _loc7_ && _loc4_.top + _loc8_ < _loc6_ && _loc6_ < _loc4_.bottom - _loc8_)
         {
            return null;
         }
         if(param2 < this.dragScrollInitialDelay)
         {
            return new Point();
         }
         param2 -= this.dragScrollInitialDelay;
         var _loc9_:Number = (_loc9_ = (_loc9_ = Math.min(param2,2000) / 2000) * 3) + 1;
         _loc9_ *= _loc9_ * this.dragScrollSpeed * this.dragScrollInterval / 50;
         ...
         {
            _loc14_ = Number(1 - (_loc5_ - _loc4_.left) / _loc7_);
            _loc14_ *= _loc14_ * _loc9_;
            _loc14_ = Number(-Math.round(_loc14_) - 1);
         }
         else if(_loc13_ != 0 && _loc4_.right - _loc5_ < _loc7_)
         {
            _loc14_ = Number(1 - (_loc4_.right - _loc5_) / _loc7_);
            _loc14_ *= _loc14_ * _loc9_;
            _loc14_ = Number(Math.round(_loc14_) + 1);
         }
         if(_loc11_ != 0 && _loc6_ - _loc4_.top < _loc8_)
         {
            _loc15_ = Number(1 - (_loc6_ - _loc4_.top) / _loc8_);
            _loc15_ *= _loc15_ * _loc9_;
            _loc15_ = Number(-Math.round(_loc15_) - 1);
         }
         else if(_loc12_ != 0 && _loc4_.bottom - _loc6_ < _loc8_)
         {
            _loc15_ = Number(1 - (_loc4_.bottom - _loc6_) / _loc8_);
            _loc15_ *= _loc15_ * _loc9_;
            _loc15_ = Number(Math.round(_loc15_) + 1);
         }
         _loc14_ = Number(Math.max(_loc10_,Math.min(_loc13_,_loc14_)));
         _loc15_ = Number(Math.max(_loc11_,Math.min(_loc12_,_loc15_)));
