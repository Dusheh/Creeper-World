package spark.layouts.supportClasses
{
   ...
   public final class LinearLayoutVector
   {
      ...
      {
         return this.pendingLength == -1 ? uint(this._length) : uint(this.pendingLength);
      }
      ...
      public function getMajorSize(param1:uint) : Number
      {
         ...
         if(_loc2_)
         {
            ...
            return !!isNaN(_loc3_) ? Number(this._defaultMajorSize) : Number(_loc3_);
         }
         return this._defaultMajorSize;
      }
      ...
      private function inBlockCopy(param1:Block, param2:int, param3:Block, param4:int, param5:int) : void
      {
         ...
         var _loc7_:int = param2 < param4 ? int(param4) : int(param4 + param5 - 1);
         var _loc8_:int = !!_loc6_ ? int(param2) : int(param2 + param5 - 1);
      ...
      private function copyInterval(param1:int, param2:int, param3:int) : void
      {
         ...
         while(param3 > 0)
         {
            _loc5_ = uint(param1 >> BLOCK_SHIFT);
            _loc6_ = uint(param1 & BLOCK_MASK);
            _loc7_ = this.blockTable[_loc5_];
            _loc8_ = uint(param2 >> BLOCK_SHIFT);
            _loc9_ = uint(param2 & BLOCK_MASK);
            ...
            _loc12_ = !!_loc4_ ? int(_loc6_) : int(_loc6_ - _loc11_ + 1);
            _loc13_ = !!_loc4_ ? int(_loc9_) : int(_loc9_ - _loc11_ + 1);
      ...
      public function start(param1:uint) : Number
      {
         ...
         return Number(_loc2_ + param1 * this.gap);
      }
      ...
      public function indexOf(param1:Number) : int
      {
         ...
         return _loc2_ >= this._length ? -1 : int(_loc2_);
      }
