package spark.primitives
{
   ...
   public class BitmapImage extends GraphicElement
   {
      ...
      override protected function measure() : void
      {
         ...
         {
            _loc1_ = Number(_loc2_.runtimeDPI / _loc2_.applicationDPI);
         }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
               ...
               case BitmapFillMode.SCALE:
                  if(_loc5_)
                  {
                     ...
                     if(_loc18_ < _loc19_)
                     {
                        ...
                        _loc11_ = Number(_loc3_ / this._bitmapData.height);
                        _loc10_ = Number(_loc34_);
                        break;
                     }
                     _loc34_ = _loc4_ / this._bitmapData.width;
                     _loc11_ = Number(_loc4_ / this._bitmapData.width);
                     _loc10_ = Number(_loc34_);
                     break;
                  }
                  _loc10_ = Number(_loc4_ / this._bitmapData.width);
                  _loc11_ = Number(_loc3_ / this._bitmapData.height);
                  break;
         ...
         if(this._fillMode != BitmapFillMode.SCALE || isNaN(this._scaleGridTop) || isNaN(this._scaleGridBottom) || isNaN(this._scaleGridLeft) || isNaN(this._scaleGridRight))
         {
            ...
            if(_loc20_ && this._fillMode == BitmapFillMode.SCALE)
            {
               if(_loc5_)
               {
                  _loc10_ = Number(_loc11_ = Number(1));
               }
               else if(this._fillMode == BitmapFillMode.SCALE)
               {
                  _loc10_ = Number(_loc4_ / _loc23_.width);
                  _loc11_ = Number(_loc3_ / _loc23_.height);
               }
            }
