package spark.core
{
   ...
   public class ContentRequest extends EventDispatcher
   {
      ...
      public function ContentRequest(param1:IContentLoader, param2:*, param3:Boolean = false, param4:Boolean = false)
      {
         ...
         param1.addEventListener("invalidateLoader",this.contentLoader_invalidateLoaderHandler,false,0,true);
      }
      ...
      {
         if(this._content && this._content is LoaderInfo)
         {
      ...
      private function addLoaderListeners() : void
      {
         ...
         if(this._content && this._content is LoaderInfo)
         {
            ...
            _loc1_.addEventListener(Event.COMPLETE,this.content_completeHandler,false,0,true);
            _loc1_.addEventListener(IOErrorEvent.IO_ERROR,this.content_ioErrorHandler,false,0,true);
      ...
      private function removeLoaderListeners() : void
      {
         ...
         {
            _loc1_ = LoaderInfo(this._content);
            _loc1_.removeEventListener(Event.COMPLETE,this.content_completeHandler);
            _loc1_.removeEventListener(IOErrorEvent.IO_ERROR,this.content_ioErrorHandler);
