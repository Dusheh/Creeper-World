package mx.events
{
   ...
   public class InterDragManagerEvent extends DragEvent
   {
      ...
      {
         return new InterDragManagerEvent(type,bubbles,cancelable,localX,localY,relatedObject,ctrlKey,altKey,shiftKey,buttonDown,delta,this.dropTarget,this.dragEventType,dragInitiator,dragSource,action,draggedItem);
      }
   }
}
