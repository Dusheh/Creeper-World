   ...
   public class ToolTipManagerImpl extends EventDispatcher implements IToolTipManager2
   {
      ...
      mx_internal function positionTip() : void
      {
         ...
         if(this.isError)
         {
            ...
            _loc3_ = Number(!!_loc2_ ? Number(_loc8_.left - 4) : Number(_loc8_.right + 4));
            _loc4_ = _loc8_.top - 1;
            if(_loc9_ = !!_loc2_ ? _loc3_ < this.currentToolTip.width : _loc3_ + this.currentToolTip.width > _loc5_)
            {
               _loc10_ = NaN;
               _loc11_ = NaN;
               _loc3_ = Number(!!_loc2_ ? Number(_loc8_.right + 2 - this.currentToolTip.width) : Number(_loc8_.left - 2));
               if(_loc2_)
               {
            ...
            {
               _loc3_ = Number(_loc8_.right + 2 - this.currentToolTip.width);
            }
         }
         else
         {
            _loc12_ = this.getSystemManager(this.currentTarget);
            _loc3_ = Number(DisplayObject(_loc12_).mouseX + 11);
            if(_loc2_)
            {
            ...
            _loc3_ = Number((_loc15_ = DisplayObject(_loc12_.getSandboxRoot()).globalToLocal(_loc15_)).x);
            _loc4_ = _loc15_.y;
         }
