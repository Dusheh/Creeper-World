package mx.managers
{
   ...
   public class WindowedSystemChildrenList implements IChildList
   {
      ...
      {
         return this.owner.rawChildren_getChildAt(this.owner[this.lowerBoundReference] + param1);
      }
      ...
      {
         var _loc2_:int = 0;
         if(this.owner.rawChildren_contains(param1))
         {
            while(param1.parent != this.owner && param1.parent != param1.stage)
            {
