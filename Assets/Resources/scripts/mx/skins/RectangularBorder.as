   ...
   public class RectangularBorder extends Border implements IRectangularBorder
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(_loc3_ != this.backgroundImageStyle)
         {
            ...
            else if(_loc3_ && _loc3_ is String)
            {
               try
               {
      ...
      public function layoutBackgroundImage() : void
      {
         ...
         {
            _loc7_ = Number((_loc14_ = _loc6_ * 0.01) * _loc4_ / this.backgroundImageWidth);
            _loc8_ = Number(_loc14_ * _loc5_ / this.backgroundImageHeight);
         }
