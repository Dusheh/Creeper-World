   ...
   public class ZoomInstance extends TweenEffectInstance
   {
      ...
      override public function play() : void
      {
         ...
         else
         {
            ...
            {
               this.zoomWidthTo = this.zoomWidthFrom == 1 ? 0 : Number(1);
            }
            ...
            {
               this.zoomHeightTo = this.zoomHeightFrom == 1 ? 0 : Number(1);
            }
         }
      ...
      private function applyPropertyChanges() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this.zoomWidthFrom = !!isNaN(this.zoomWidthFrom) ? 0 : Number(this.zoomWidthFrom);
               this.zoomWidthTo = !!isNaN(this.zoomWidthTo) ? Number(_loc1_.end["scaleX"]) : Number(this.zoomWidthTo);
               _loc3_ = true;
            }
            if(_loc1_.end["scaleY"] !== undefined)
            {
               this.zoomHeightFrom = !!isNaN(this.zoomHeightFrom) ? 0 : Number(this.zoomHeightFrom);
