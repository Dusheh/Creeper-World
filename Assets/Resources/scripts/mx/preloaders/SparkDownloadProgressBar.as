package mx.preloaders
{
   ...
   public class SparkDownloadProgressBar extends Sprite implements IPreloaderDisplay
   {
      ...
      private function initBackgroundImage(param1:DisplayObject) : void
      {
         ...
         {
            _loc7_ = Number((_loc9_ = _loc4_ * 0.01) * this.stageWidth / _loc2_);
            _loc8_ = Number(_loc9_ * this.stageHeight / _loc3_);
         }
...
class ErrorField extends Sprite
{
   ...
   public function show(param1:String) : void
   {
      ...
      _loc4_.text = param1;
      _loc4_.width = Math.max(this.MIN_WIDTH_INCHES * 0,_loc2_ - this.TEXT_MARGIN_PX * 2);
      _loc4_.width = Math.min(this.MAX_WIDTH_INCHES * 0,_loc4_.width);
