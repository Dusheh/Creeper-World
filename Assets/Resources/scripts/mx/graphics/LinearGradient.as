package mx.graphics
{
   ...
   public class LinearGradient extends GradientBase implements IFill
   {
      ...
      {
         return !!compoundTransform ? 0 : Number(this._scaleX);
      }
         ...
         if(!compoundTransform)
         {
            ...
            if(isNaN(_loc6_))
            {
               if(rotation % 90 != 0)
               {
                  ...
                  _loc6_ = Number(_loc8_ / Math.cos(_loc7_ / 180 * 0));
               }
               else
               {
                  _loc6_ = Number(rotation % 180 == 0 ? Number(param2.width) : Number(param2.height));
               }
            }
            ...
            if(isNaN(_loc4_))
            {
               _loc4_ = Number(param2.left + param2.width / 2);
            }
            else
            {
               _loc4_ += param3.x;
            ...
            if(isNaN(_loc5_))
            {
               _loc5_ = Number(param2.top + param2.height / 2);
            }
            else
            {
               _loc5_ += param3.y;
