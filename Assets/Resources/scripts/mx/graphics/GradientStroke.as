package mx.graphics
{
   ...
   public class GradientStroke extends GradientBase implements IStroke
   {
      ...
      public function set caps(param1:String) : void
      {
         ...
         {
            this._caps = param1;
            dispatchGradientChangedEvent("caps",_loc2_,param1);
         }
      }
      ...
      public function set joints(param1:String) : void
      {
         ...
         {
            this._joints = param1;
            dispatchGradientChangedEvent("joints",_loc2_,param1);
         }
      }
      ...
      public function set miterLimit(param1:Number) : void
      {
         ...
         if(param1 != _loc2_)
         {
            ...
            dispatchGradientChangedEvent("miterLimit",_loc2_,param1);
         }
      }
      ...
      public function set pixelHinting(param1:Boolean) : void
      {
         ...
         if(param1 != _loc2_)
         {
            ...
            dispatchGradientChangedEvent("pixelHinting",_loc2_,param1);
         }
      }
      ...
      public function set scaleMode(param1:String) : void
      {
         ...
         if(param1 != _loc2_)
         {
            ...
            dispatchGradientChangedEvent("scaleMode",_loc2_,param1);
         }
      }
      ...
      public function set weight(param1:Number) : void
      {
         ...
         {
            this._weight = param1;
            dispatchGradientChangedEvent("weight",_loc2_,param1);
         }
      }
