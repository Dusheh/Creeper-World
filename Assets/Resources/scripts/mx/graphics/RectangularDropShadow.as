package mx.graphics
{
   ...
   public class RectangularDropShadow
   {
      ...
      public function drawShadow(param1:Graphics, param2:Number, param3:Number, param4:Number, param5:Number) : void
      {
         ...
         var _loc6_:int = !!this.leftShadow ? int(this.leftShadow.width) : 0;
         var _loc7_:int = !!this.rightShadow ? int(this.rightShadow.width) : 0;
         var _loc8_:int = !!this.topShadow ? int(this.topShadow.height) : 0;
         var _loc9_:int = !!this.bottomShadow ? int(this.bottomShadow.height) : 0;
         ...
         if(this.leftShadow || this.topShadow)
         {
         ...
         if(this.rightShadow || this.topShadow)
         {
         ...
         if(this.leftShadow || this.bottomShadow)
         {
         ...
         if(this.rightShadow || this.bottomShadow)
         {
