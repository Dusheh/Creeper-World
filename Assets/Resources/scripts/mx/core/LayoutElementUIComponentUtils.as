package mx.core
{
   ...
   public class LayoutElementUIComponentUtils
   {
      ...
      private static function getPreferredUBoundsWidth(param1:IUIComponent) : Number
      {
         ...
         if(false)
         {
            _loc2_ = param1.scaleX == 0 ? 0 : Number(_loc2_ / param1.scaleX);
         }
         return _loc2_;
      }
      ...
      private static function getPreferredUBoundsHeight(param1:IUIComponent) : Number
      {
         ...
         if(false)
         {
            _loc2_ = param1.scaleY == 0 ? 0 : Number(_loc2_ / param1.scaleY);
         }
         return _loc2_;
      }
      ...
      public static function getLayoutBoundsWidth(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(false)
         {
            _loc3_ = param1.scaleX == 0 ? 0 : Number(_loc3_ / param1.scaleX);
         }
         if(param2)
         {
            ...
            if(false)
            {
               _loc4_ = param1.scaleY == 0 ? 0 : Number(_loc4_ / param1.scaleY);
            }
      ...
      public static function getLayoutBoundsHeight(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(false)
         {
            _loc3_ = param1.scaleY == 0 ? 0 : Number(_loc3_ / param1.scaleY);
         }
         if(param2)
         {
            _loc4_ = param1.width;
            if(false)
            {
               _loc4_ = param1.scaleX == 0 ? 0 : Number(_loc4_ / param1.scaleX);
            }
